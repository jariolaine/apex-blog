...
function org_blogsite_jaris_SetCHKEditor(a){if("undefined"===typeof CKEDITOR)return!1;CKEDITOR.config.stylesSet=[{name:"SyntaxHighlighter",element:"pre",attributes:{"class":"brush:plain program-code"}},{name:"Blue Title",element:"h3",styles:{color:"Blue"}},{name:"Red Title",element:"h3",styles:{color:"Red"}},{name:"Marker: Yellow",element:"span",styles:{"background-color":"Yellow"}},{name:"Marker: Green",element:"span",styles:{"background-color":"Lime"}},{name:"Big",element:"big"},{name:"Small",element:"small"}, {name:"Typewriter",element:"tt"},{name:"Computer Code",element:"code"},{name:"Keyboard Phrase",element:"kbd"},{name:"Sample Text",element:"samp"},{name:"Variable",element:"var"},{name:"Deleted Text",element:"del"},{name:"Inserted Text",element:"ins"},{name:"Cited Work",element:"cite"},{name:"Inline Quotation",element:"q"},{name:"Language: RTL",element:"span",attributes:{dir:"rtl"}},{name:"Language: LTR",element:"span",attributes:{dir:"ltr"}},{name:"Image on Left",element:"img",attributes:{style:"padding: 5px; margin-right: 5px", border:"2",align:"left"}},{name:"Image on Right",element:"img",attributes:{style:"padding: 5px; margin-left: 5px",border:"2",align:"right"}},{name:"Borderless Table",element:"table",styles:{"border-style":"hidden","background-color":"#E6E6FA"}},{name:"Square Bulleted List",element:"ul",styles:{"list-style-type":"square"}}];if(a){var b=[];b.push(CKEDITOR.config.contentsCss);b.push(a);CKEDITOR.config.contentsCss=b}CKEDITOR.config.entities_additional="#x23,#x27,#x2F";CKEDITOR.config.forcePasteAsPlainText= !0;CKEDITOR.config.startupOutlineBlocks=!0}function org_blogsite_jaris_MaxItemLength(){var a=1*this.action.attribute01,b=this.action.attribute02,d=!1;this.affectedElements.each(function(c){c=$.trim($('label[for="'+this.id+'"]').text());$v(this).length>=a&&(alert(c+b),d=!0)});d&&event.preventDefault()}function org_blogsite_jaris_SubmitClob(a,b,d,c){apex.server.process(d,{f01:$s_Split(a.getData(),4E3)},{dataType:"html",success:function(a){$(b).attr("disabled","disabled");c&&apex.submit(c)}})};
