...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE VIEW "BLOG_040000"."BLOG_V_POSTS_LAST20" ("POST_ID", "CREATED_ON", "DISPLAY_SEQ", "BLOGGER_NAME", "POST_TITLE", "POST_DESC", "CATEGORY_TITLE", "RSS_TITLE", "RSS_DESC", "RSS_CATEGORY", "PUBDATE") AS 
  with qry as (
