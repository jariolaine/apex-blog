...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE VIEW "BLOG_040000"."BLOG_V_ALL_TAGS" ("TAG_ID", "ROW_VERSION", "CREATED_ON", "CREATED_BY", "CHANGED_ON", "CHANGED_BY", "TAG", "IS_ACTIVE", "POSTS_COUNT", "ALLOWED_ROW_OPERATION") AS 
