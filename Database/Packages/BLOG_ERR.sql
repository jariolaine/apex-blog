...
--------------------------------------------------------------------------------
  ...
  begin
    ...
    apex_debug.enter(
       p_routine_name => 'blog_err.apex_error_handler'
      ,p_name01 => 'APP_SESSION'
      ,p_value01 => sys_context( 'APEX$SESSION', 'APP_SESSION' )
      ,p_name02 => 'APP_USER'
      ,p_value02 => sys_context( 'APEX$SESSION', 'APP_USER' )
      ,p_name03 => 'apex_error_code'
      ,p_value03 => p_error.apex_error_code
      ,p_name04 => 'message'
      ,p_value04 => l_result.message
      ,p_name05 => 'additional_info'
      ,p_value05 => l_result.additional_info
      ,p_name06 => 'ora_sqlcode'
      ,p_value06 => p_error.ora_sqlcode
      ,p_name07 => 'ora_sqlerrm'
      ,p_value07 => p_error.ora_sqlerrm
      ,p_name08 => 'sqlcode'
      ,p_value08 => sqlcode
      ,p_name09 => 'apex_error.extract_constraint_name'
      ,p_value09 => apex_error.extract_constraint_name(
            p_error => p_error
          )
    );
