...
create table blog_comments(
  ...
  comment_preview varchar2( 4000 byte ) not null,
  ctx_search char( 1 byte ) not null,
  constraint blog_comments_pk primary key( id ),
  constraint blog_comments_ck1 check( row_version > 0 ),
  constraint blog_comments_ck2 check( is_active in( 0 , 1 ) )
)
/
--------------------------------------------------------
...
ALTER TABLE "BLOG_COMMENT_SENTIMENTS" ADD CONSTRAINT "BLOG_COMMENT_SENTIMENTS_FK1" FOREIGN KEY ("COMMENT_ID")
  REFERENCES "BLOG_COMMENTS" ("ID") ON DELETE CASCADE ENABLE;
