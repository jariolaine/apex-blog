...
insert into blog_settings(display_seq, is_nullable, attribute_name, data_type, group_name, post_expression, int_min,int_max, install_value, attribute_value) values('200','1','G_RSS_URL','URL','BLOG_PAR_GROUP_SEO',null,null,null,'apex_util.host_url(''SCRIPT'') || ''f?p='' || blog_util.int_to_vc2(apex_application_install.get_application_id) || '':home::application_process=rss.xml''',apex_util.host_url('SCRIPT') || 'f?p=' || blog_util.int_to_vc2(apex_application_install.get_application_id) || ':home::application_process=rss.xml');
insert into blog_settings(display_seq, is_nullable, attribute_name, data_type, group_name, post_expression, int_min,int_max, install_value, attribute_value) values('210','1','G_RSS_XSL_URL','URL','BLOG_PAR_GROUP_SEO',null,null,null,'apex_util.host_url(''SCRIPT'') || ''f?p='' || blog_util.int_to_vc2(apex_application_install.get_application_id) || '':home::application_process=rss.xsl''',apex_util.host_url('SCRIPT') || 'f?p=' || blog_util.int_to_vc2(apex_application_install.get_application_id) || ':home::application_process=rss.xsl');
insert into blog_settings(display_seq, is_nullable, attribute_name, data_type, group_name, post_expression, int_min,int_max, install_value, attribute_value) values('220','1','G_RSS_XSL_CSS_URL','STRING','INTERNAL',null,null,null,'''apex_util.host_url(''''APEX_PATH'''') || :WORKSPACE_IMAGES || ''''blog/1.0/css/rss-xsl.css''''''','apex_util.host_url(''APEX_PATH'') || :WORKSPACE_IMAGES || ''blog/1.0/css/rss-xsl.css''');
insert into blog_settings(display_seq, is_nullable, attribute_name, data_type, group_name, post_expression, int_min,int_max, install_value, attribute_value) values('230','1','G_SITEMAP_URL','URL','BLOG_PAR_GROUP_SEO',null,null,null,'apex_util.host_url(''SCRIPT'') || ''f?p='' || blog_util.int_to_vc2(apex_application_install.get_application_id) || '':home::application_process=sitemapindex.xml''',apex_util.host_url('SCRIPT') || 'f?p=' || blog_util.int_to_vc2(apex_application_install.get_application_id) || ':home::application_process=sitemapindex.xml');
