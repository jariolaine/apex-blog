...
insert into blog_features (is_active,display_seq,build_option_name,build_option_group,build_option_parent,help_message) values ('1','220','BLOG_FEATURE_FILES','BLOG_FEATURE_GROUP_PAGE',null,null);
insert into blog_features (is_active,display_seq,build_option_name,build_option_group,build_option_parent,help_message) values ('1','230','BLOG_FEATURE_ABOUT','BLOG_FEATURE_GROUP_PAGE',null,null);
insert into blog_features (is_active,display_seq,build_option_name,build_option_group,build_option_parent,help_message) values ('1','240','BLOG_FEATURE_SEARCH_LINKS','BLOG_FEATURE_GROUP_MISC','BLOG_FEATURE_LINKS',null);
insert into blog_features (is_active,display_seq,build_option_name,build_option_group,build_option_parent,help_message) values ('1','250','BLOG_FEATURE_SEARCH_FILES','BLOG_FEATURE_GROUP_MISC','BLOG_FEATURE_FILES',null);
...
insert into blog_settings (display_seq,is_nullable,attribute_name,data_type,group_name,post_expression,int_min,int_max,help_message,attribute_value) values ('30','0','G_APP_VERSION','STRING','INTERNAL',null,null,null,null,'Release 4.4.20211024');
...
insert into blog_settings (display_seq,is_nullable,attribute_name,data_type,group_name,post_expression,int_min,int_max,help_message,attribute_value) values ('60','1','G_SITEMAP_URL','URL','INTERNAL',null,null,null,null,apex_util.host_url('SCRIPT') || 'f?p=' || blog_util.int_to_vc2(apex_application_install.get_application_id) || ':home::application_process=sitemap-index.xml');
...
insert into blog_settings (display_seq,is_nullable,attribute_name,data_type,group_name,post_expression,int_min,int_max,help_message,attribute_value) values ('230','1','G_RSS_URL','URL','BLOG_PAR_GROUP_SEO',null,null,null,null,apex_util.host_url('SCRIPT') || 'f?p=' || blog_util.int_to_vc2(apex_application_install.get_application_id) || ':home::application_process%3Drss.xml');
insert into blog_settings (display_seq,is_nullable,attribute_name,data_type,group_name,post_expression,int_min,int_max,help_message,attribute_value) values ('240','1','G_RSS_XSL_URL','URL','BLOG_PAR_GROUP_SEO',null,null,null,null,apex_util.host_url('SCRIPT') || 'f?p=' || blog_util.int_to_vc2(apex_application_install.get_application_id) || ':home::application_process%3Drss.xsl');
--
--------------------------------------------------------
