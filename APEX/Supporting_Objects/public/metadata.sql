...
--------------------------------------------------------
insert into blog_settings (display_seq,is_nullable,attribute_name,data_type,attribute_group_message,post_expression,int_min,int_max,help_message,attribute_value) values ('20','1','G_PUB_APP_ID','STRING','INTERNAL',null,null,null,null,blog_util.int_to_vc2(apex_application_install.get_application_id));
insert into blog_settings (display_seq,is_nullable,attribute_name,data_type,attribute_group_message,post_expression,int_min,int_max,help_message,attribute_value) values ('30','0','G_APP_VERSION','STRING','INTERNAL',null,null,null,null,'Release 4.4.20211120');
insert into blog_settings (display_seq,is_nullable,attribute_name,data_type,attribute_group_message,post_expression,int_min,int_max,help_message,attribute_value) values ('40','0','G_ADMIN_APP_AUTHZ_GROUP','STRING','INTERNAL',null,null,null,null,'Bloggers');
insert into blog_settings (display_seq,is_nullable,attribute_name,data_type,attribute_group_message,post_expression,int_min,int_max,help_message,attribute_value) values ('50','1','G_RSS_XSL_CSS_URL','STRING','INTERNAL',null,null,null,null,'css/rss-xsl.css');
...
insert into blog_settings (display_seq,is_nullable,attribute_name,data_type,attribute_group_message,post_expression,int_min,int_max,help_message,attribute_value) values ('130','0','G_APP_NAME','STRING','BLOG_SETTING_GROUP_GENERAL',null,null,null,null,'My Blog');
insert into blog_settings (display_seq,is_nullable,attribute_name,data_type,attribute_group_message,post_expression,int_min,int_max,help_message,attribute_value) values ('140','0','G_APP_DESC','STRING','BLOG_SETTING_GROUP_GENERAL',null,null,null,null,'About Almost Everything');
insert into blog_settings (display_seq,is_nullable,attribute_name,data_type,attribute_group_message,post_expression,int_min,int_max,help_message,attribute_value) values ('150','1','G_APP_EMAIL','EMAIL','BLOG_SETTING_GROUP_GENERAL',null,null,null,'BLOG_HELP_G_APP_EMAIL',null);
insert into blog_settings (display_seq,is_nullable,attribute_name,data_type,attribute_group_message,post_expression,int_min,int_max,help_message,attribute_value) values ('160','0','G_DATE_FORMAT','DATE_FORMAT','BLOG_SETTING_GROUP_UI',null,null,null,null,'fmDD Mon YYYY');
insert into blog_settings (display_seq,is_nullable,attribute_name,data_type,attribute_group_message,post_expression,int_min,int_max,help_message,attribute_value) values ('170','0','G_POST_TITLE_DATE_FORMAT','DATE_FORMAT','BLOG_SETTING_GROUP_UI',null,null,null,null,'fmDay, Month DD, YYYY');
insert into blog_settings (display_seq,is_nullable,attribute_name,data_type,attribute_group_message,post_expression,int_min,int_max,help_message,attribute_value) values ('200','0','P1_REPORT_ROWS','INTEGER','BLOG_SETTING_GROUP_REPORTS',null,'1','50',null,'5');
insert into blog_settings (display_seq,is_nullable,attribute_name,data_type,attribute_group_message,post_expression,int_min,int_max,help_message,attribute_value) values ('210','0','P2_REPORT_ROWS','INTEGER','BLOG_SETTING_GROUP_REPORTS',null,'1','50',null,'10');
insert into blog_settings (display_seq,is_nullable,attribute_name,data_type,attribute_group_message,post_expression,int_min,int_max,help_message,attribute_value) values ('230','0','G_LATEST_POST_ROWS','INTEGER','BLOG_SETTING_GROUP_REPORTS',null,'1','20',null,'5');
insert into blog_settings (display_seq,is_nullable,attribute_name,data_type,attribute_group_message,post_expression,int_min,int_max,help_message,attribute_value) values ('240','0','G_SEARCH_ROWS','INTEGER','BLOG_SETTING_GROUP_REPORTS',null,'1','50',null,'10');
insert into blog_settings (display_seq,is_nullable,attribute_name,data_type,attribute_group_message,post_expression,int_min,int_max,help_message,attribute_value) values ('300','0','G_CANONICAL_URL','URL','BLOG_SETTING_GROUP_SEO','trim( rtrim( :ATTRIBUTE_VALUE, ''/'' ) )',null,null,'BLOG_HELP_G_CANONICAL_URL',apex_util.host_url());
insert into blog_settings (display_seq,is_nullable,attribute_name,data_type,attribute_group_message,post_expression,int_min,int_max,help_message,attribute_value) values ('310','1','G_RSS_URL','URL','BLOG_SETTING_GROUP_SEO',null,null,null,'BLOG_HELP_G_RSS_URL',null);
insert into blog_settings (display_seq,is_nullable,attribute_name,data_type,attribute_group_message,post_expression,int_min,int_max,help_message,attribute_value) values ('320','1','G_RSS_XSL_URL','URL','BLOG_SETTING_GROUP_SEO',null,null,null,null,null);
--
--------------------------------------------------------
