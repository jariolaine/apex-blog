...
insert into blog_settings (display_seq,is_nullable,attribute_name,data_type,group_name,post_expression,int_min,int_max,help_message,attribute_value) values ('30','0','G_APP_VERSION','STRING','INTERNAL',null,null,null,null,'Release 4.4-20210908');
...
insert into blog_settings (display_seq,is_nullable,attribute_name,data_type,group_name,post_expression,int_min,int_max,help_message,attribute_value) values ('190','0','G_ARCHIVE_DATE_FORMAT','DATE_FORMAT','BLOG_PAR_GROUP_UI',null,null,null,null,'fmMonth, YYYY');
