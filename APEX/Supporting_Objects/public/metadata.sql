...
insert into blog_settings(display_seq,is_nullable,attribute_name,data_type,attribute_group_message,post_expression,int_min,int_max,attribute_value) values('610','1','G_CANONICAL_HOST','URL','BLOG_SETTING_GROUP_SEO','trim( rtrim( :ATTRIBUTE_VALUE, ''/'' ) )',null,null,null);
...
insert into blog_features(is_active,display_seq,build_option_name,build_option_group,build_option_parent,help_message) values('1','280','BLOG_FEATURE_TAG_CLOUD_POST_COUNT','BLOG_FEATURE_GROUP_RIGHT_COLUMN','BLOG_FEATURE_TAG_CLOUD','BLOG_HELP_FEATURE_TAG_CLOUD_POST_COUNT');
