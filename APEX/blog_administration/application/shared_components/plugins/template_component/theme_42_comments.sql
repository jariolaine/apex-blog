...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1809984681431286512)
,p_plugin_id=>wwv_flow_imp.id(14251390132203028)
,p_title=>'Avatar'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10099992504254794)
,p_plugin_id=>wwv_flow_imp.id(14251390132203028)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10100435351254794)
,p_plugin_id=>wwv_flow_imp.id(14251390132203028)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10100973014254793)
,p_plugin_id=>wwv_flow_imp.id(14251390132203028)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10101420898254793)
,p_plugin_id=>wwv_flow_imp.id(14251390132203028)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10101977291254792)
,p_plugin_id=>wwv_flow_imp.id(14251390132203028)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(10109180024254784)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1809984681431286512)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10102447966254792)
,p_plugin_attribute_id=>wwv_flow_imp.id(10101977291254792)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10103089944254791)
,p_plugin_attribute_id=>wwv_flow_imp.id(10101977291254792)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10103633194254791)
,p_plugin_attribute_id=>wwv_flow_imp.id(10101977291254792)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10104254655254790)
,p_plugin_id=>wwv_flow_imp.id(14251390132203028)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(10101977291254792)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10104746854254790)
,p_plugin_id=>wwv_flow_imp.id(14251390132203028)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10105235302254790)
,p_plugin_id=>wwv_flow_imp.id(14251390132203028)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10105706806254789)
,p_plugin_id=>wwv_flow_imp.id(14251390132203028)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10106298089254789)
,p_plugin_id=>wwv_flow_imp.id(14251390132203028)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10108504595254785)
,p_plugin_attribute_id=>wwv_flow_imp.id(10106298089254789)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10106750941254788)
,p_plugin_attribute_id=>wwv_flow_imp.id(10106298089254789)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10107337183254788)
,p_plugin_attribute_id=>wwv_flow_imp.id(10106298089254789)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10107913050254787)
,p_plugin_attribute_id=>wwv_flow_imp.id(10106298089254789)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10109180024254784)
,p_plugin_id=>wwv_flow_imp.id(14251390132203028)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10109625897254784)
,p_plugin_id=>wwv_flow_imp.id(14251390132203028)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10110155583254783)
,p_plugin_id=>wwv_flow_imp.id(14251390132203028)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10110655081254783)
,p_plugin_attribute_id=>wwv_flow_imp.id(10110155583254783)
,p_display_sequence=>10
,p_display_value=>'Basic'
,p_return_value=>'t-Comments--basic'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10111259983254783)
,p_plugin_attribute_id=>wwv_flow_imp.id(10110155583254783)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10111895666254782)
,p_plugin_id=>wwv_flow_imp.id(14251390132203028)
,p_attribute_scope=>'REPORT'
