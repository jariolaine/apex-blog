...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(96714239918035134)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74518755107825021)
,p_plugin_id=>wwv_flow_imp.id(96714239918035134)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74519212237825016)
,p_plugin_id=>wwv_flow_imp.id(96714239918035134)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74519739615825015)
,p_plugin_id=>wwv_flow_imp.id(96714239918035134)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74520296539824996)
,p_plugin_id=>wwv_flow_imp.id(96714239918035134)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74520691294824995)
,p_plugin_id=>wwv_flow_imp.id(96714239918035134)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74521154593824994)
,p_plugin_id=>wwv_flow_imp.id(96714239918035134)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74521636467824992)
,p_plugin_id=>wwv_flow_imp.id(96714239918035134)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74522102483824991)
,p_plugin_id=>wwv_flow_imp.id(96714239918035134)
,p_attribute_scope=>'COMPONENT'
