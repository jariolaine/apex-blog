...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10095148537254802)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10095606434254801)
,p_plugin_id=>wwv_flow_imp.id(14268117276203043)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10096146912254801)
,p_plugin_id=>wwv_flow_imp.id(14268117276203043)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10096659567254800)
,p_plugin_id=>wwv_flow_imp.id(14268117276203043)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10097179028254800)
,p_plugin_id=>wwv_flow_imp.id(14268117276203043)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10097614815254799)
,p_plugin_id=>wwv_flow_imp.id(14268117276203043)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10098161828254799)
,p_plugin_id=>wwv_flow_imp.id(14268117276203043)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10098670871254799)
,p_plugin_id=>wwv_flow_imp.id(14268117276203043)
,p_attribute_scope=>'COMPONENT'
