...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14268684561203044)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14269103904203044)
,p_plugin_id=>wwv_flow_imp.id(14268117276203043)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14269652665203044)
,p_plugin_id=>wwv_flow_imp.id(14268117276203043)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14270175470203045)
,p_plugin_id=>wwv_flow_imp.id(14268117276203043)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14270631516203045)
,p_plugin_id=>wwv_flow_imp.id(14268117276203043)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14271161036203045)
,p_plugin_id=>wwv_flow_imp.id(14268117276203043)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14271629089203046)
,p_plugin_id=>wwv_flow_imp.id(14268117276203043)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14272152640203046)
,p_plugin_id=>wwv_flow_imp.id(14268117276203043)
,p_attribute_scope=>'COMPONENT'
