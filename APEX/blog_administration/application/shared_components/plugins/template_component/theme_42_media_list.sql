...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(96781975321035194)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1874603009267708512)
,p_plugin_id=>wwv_flow_imp.id(96781975321035194)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1874602454255708511)
,p_plugin_id=>wwv_flow_imp.id(96781975321035194)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74585743105824861)
,p_plugin_id=>wwv_flow_imp.id(96781975321035194)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74586257356824860)
,p_plugin_id=>wwv_flow_imp.id(96781975321035194)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74586791382824859)
,p_plugin_id=>wwv_flow_imp.id(96781975321035194)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74587290682824859)
,p_plugin_id=>wwv_flow_imp.id(96781975321035194)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74587739569824858)
,p_plugin_id=>wwv_flow_imp.id(96781975321035194)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(74586791382824859)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1874603009267708512)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74588217230824858)
,p_plugin_attribute_id=>wwv_flow_imp.id(74587739569824858)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74588890576824857)
,p_plugin_attribute_id=>wwv_flow_imp.id(74587739569824858)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74589414284824857)
,p_plugin_attribute_id=>wwv_flow_imp.id(74587739569824858)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74590081331824855)
,p_plugin_id=>wwv_flow_imp.id(96781975321035194)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(74587739569824858)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74590552175824854)
,p_plugin_id=>wwv_flow_imp.id(96781975321035194)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74591090267824853)
,p_plugin_id=>wwv_flow_imp.id(96781975321035194)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74591549652824851)
,p_plugin_id=>wwv_flow_imp.id(96781975321035194)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74592038173824850)
,p_plugin_id=>wwv_flow_imp.id(96781975321035194)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74592551577824846)
,p_plugin_attribute_id=>wwv_flow_imp.id(74592038173824850)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74593132474824843)
,p_plugin_attribute_id=>wwv_flow_imp.id(74592038173824850)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74593788560824837)
,p_plugin_attribute_id=>wwv_flow_imp.id(74592038173824850)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74594379841824835)
,p_plugin_attribute_id=>wwv_flow_imp.id(74592038173824850)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74594939331824833)
,p_plugin_id=>wwv_flow_imp.id(96781975321035194)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'RAW'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(74587290682824859)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(1874602454255708511)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74595486262824831)
,p_plugin_id=>wwv_flow_imp.id(96781975321035194)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74595922494824830)
,p_plugin_id=>wwv_flow_imp.id(96781975321035194)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74596405016824824)
,p_plugin_id=>wwv_flow_imp.id(96781975321035194)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74596958370824818)
,p_plugin_id=>wwv_flow_imp.id(96781975321035194)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74597471884824816)
,p_plugin_id=>wwv_flow_imp.id(96781975321035194)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74597940959824816)
,p_plugin_attribute_id=>wwv_flow_imp.id(74597471884824816)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74598577250824815)
,p_plugin_attribute_id=>wwv_flow_imp.id(74597471884824816)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74599158634824815)
,p_plugin_id=>wwv_flow_imp.id(96781975321035194)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74599633544824814)
,p_plugin_attribute_id=>wwv_flow_imp.id(74599158634824815)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74600295165824813)
,p_plugin_attribute_id=>wwv_flow_imp.id(74599158634824815)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74600729538824813)
,p_plugin_attribute_id=>wwv_flow_imp.id(74599158634824815)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74601383015824812)
,p_plugin_id=>wwv_flow_imp.id(96781975321035194)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74601892165824812)
,p_plugin_attribute_id=>wwv_flow_imp.id(74601383015824812)
,p_display_sequence=>10
,p_display_value=>'2 Column Grid'
,p_return_value=>'t-MediaList--cols t-MediaList--2cols'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74602454933824811)
,p_plugin_attribute_id=>wwv_flow_imp.id(74601383015824812)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74603084105824811)
,p_plugin_attribute_id=>wwv_flow_imp.id(74601383015824812)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74603666397824810)
,p_plugin_attribute_id=>wwv_flow_imp.id(74601383015824812)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74604293695824810)
,p_plugin_attribute_id=>wwv_flow_imp.id(74601383015824812)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74604872338824809)
,p_plugin_id=>wwv_flow_imp.id(96781975321035194)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74605374921824809)
,p_plugin_attribute_id=>wwv_flow_imp.id(74604872338824809)
,p_display_sequence=>10
,p_display_value=>'Large'
,p_return_value=>'t-MediaList--large force-fa-lg'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74605901775824808)
,p_plugin_id=>wwv_flow_imp.id(96781975321035194)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1897003648110065472)
,p_plugin_id=>wwv_flow_imp.id(96781975321035194)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
