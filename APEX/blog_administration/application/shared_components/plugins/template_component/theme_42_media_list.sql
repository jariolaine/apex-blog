...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(14335852679203103)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1814353918299086752)
,p_plugin_id=>wwv_flow_imp.id(14335852679203103)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1814354473311086753)
,p_plugin_id=>wwv_flow_imp.id(14335852679203103)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14337134561203104)
,p_plugin_id=>wwv_flow_imp.id(14335852679203103)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14337635777203105)
,p_plugin_id=>wwv_flow_imp.id(14335852679203103)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14338164829203105)
,p_plugin_id=>wwv_flow_imp.id(14335852679203103)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14338638835203105)
,p_plugin_id=>wwv_flow_imp.id(14335852679203103)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14339102510203106)
,p_plugin_id=>wwv_flow_imp.id(14335852679203103)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(14338164829203105)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1814354473311086753)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14339693658203106)
,p_plugin_attribute_id=>wwv_flow_imp.id(14339102510203106)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14340294181203106)
,p_plugin_attribute_id=>wwv_flow_imp.id(14339102510203106)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14340847808203107)
,p_plugin_attribute_id=>wwv_flow_imp.id(14339102510203106)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14341406249203107)
,p_plugin_id=>wwv_flow_imp.id(14335852679203103)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(14339102510203106)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14341995210203107)
,p_plugin_id=>wwv_flow_imp.id(14335852679203103)
,p_attribute_scope=>'COMPONENT'
...
,p_depending_on_attribute_id=>wwv_flow_imp.id(14341406249203107)
,p_depending_on_has_to_exist=>true
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14342429219203108)
,p_plugin_id=>wwv_flow_imp.id(14335852679203103)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14342950536203108)
,p_plugin_id=>wwv_flow_imp.id(14335852679203103)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14343404705203108)
,p_plugin_id=>wwv_flow_imp.id(14335852679203103)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14343981130203108)
,p_plugin_attribute_id=>wwv_flow_imp.id(14343404705203108)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14344521983203109)
,p_plugin_attribute_id=>wwv_flow_imp.id(14343404705203108)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14345187853203109)
,p_plugin_attribute_id=>wwv_flow_imp.id(14343404705203108)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14345718827203109)
,p_plugin_attribute_id=>wwv_flow_imp.id(14343404705203108)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14346352189203110)
,p_plugin_id=>wwv_flow_imp.id(14335852679203103)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(14338638835203105)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(1814353918299086752)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14346881544203110)
,p_plugin_id=>wwv_flow_imp.id(14335852679203103)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14347300528203110)
,p_plugin_id=>wwv_flow_imp.id(14335852679203103)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14347840310203110)
,p_plugin_id=>wwv_flow_imp.id(14335852679203103)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14348314239203111)
,p_plugin_id=>wwv_flow_imp.id(14335852679203103)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14348811580203111)
,p_plugin_id=>wwv_flow_imp.id(14335852679203103)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14349329114203111)
,p_plugin_attribute_id=>wwv_flow_imp.id(14348811580203111)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14349985850203112)
,p_plugin_attribute_id=>wwv_flow_imp.id(14348811580203111)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14350520807203112)
,p_plugin_id=>wwv_flow_imp.id(14335852679203103)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14351055422203112)
,p_plugin_attribute_id=>wwv_flow_imp.id(14350520807203112)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14351655707203113)
,p_plugin_attribute_id=>wwv_flow_imp.id(14350520807203112)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14352248231203113)
,p_plugin_attribute_id=>wwv_flow_imp.id(14350520807203112)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14352890889203113)
,p_plugin_id=>wwv_flow_imp.id(14335852679203103)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14353314850203113)
,p_plugin_attribute_id=>wwv_flow_imp.id(14352890889203113)
,p_display_sequence=>10
,p_display_value=>'2 Column Grid'
,p_return_value=>'t-MediaList--cols t-MediaList--2cols'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14353974152203114)
,p_plugin_attribute_id=>wwv_flow_imp.id(14352890889203113)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14354573299203114)
,p_plugin_attribute_id=>wwv_flow_imp.id(14352890889203113)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14355139507203114)
,p_plugin_attribute_id=>wwv_flow_imp.id(14352890889203113)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14355771735203115)
,p_plugin_attribute_id=>wwv_flow_imp.id(14352890889203113)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14356358857203115)
,p_plugin_id=>wwv_flow_imp.id(14335852679203103)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14356883200203115)
,p_plugin_attribute_id=>wwv_flow_imp.id(14356358857203115)
,p_display_sequence=>10
,p_display_value=>'Large'
,p_return_value=>'t-MediaList--large force-fa-lg'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14357478598203116)
,p_plugin_id=>wwv_flow_imp.id(14335852679203103)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1814557525468233381)
,p_plugin_id=>wwv_flow_imp.id(14335852679203103)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
