...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10071114749254826)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10071655121254825)
,p_plugin_attribute_id=>wwv_flow_imp.id(10071114749254826)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'IMAGE'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10072210531254825)
,p_plugin_attribute_id=>wwv_flow_imp.id(10071114749254826)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10072846653254824)
,p_plugin_attribute_id=>wwv_flow_imp.id(10071114749254826)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10073460354254824)
,p_plugin_id=>wwv_flow_imp.id(14227838373202985)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(10071114749254826)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10073908383254823)
,p_plugin_id=>wwv_flow_imp.id(14227838373202985)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10074498890254823)
,p_plugin_id=>wwv_flow_imp.id(14227838373202985)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10074944085254822)
,p_plugin_id=>wwv_flow_imp.id(14227838373202985)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10075450937254822)
,p_plugin_id=>wwv_flow_imp.id(14227838373202985)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10075938999254821)
,p_plugin_attribute_id=>wwv_flow_imp.id(10075450937254822)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10076588922254821)
,p_plugin_attribute_id=>wwv_flow_imp.id(10075450937254822)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10077167974254820)
,p_plugin_attribute_id=>wwv_flow_imp.id(10075450937254822)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10077715954254820)
,p_plugin_attribute_id=>wwv_flow_imp.id(10075450937254822)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10078314051254819)
,p_plugin_id=>wwv_flow_imp.id(14227838373202985)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10078887529254819)
,p_plugin_attribute_id=>wwv_flow_imp.id(10078314051254819)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10079424478254818)
,p_plugin_attribute_id=>wwv_flow_imp.id(10078314051254819)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10080073898254818)
,p_plugin_attribute_id=>wwv_flow_imp.id(10078314051254819)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10080680857254817)
,p_plugin_attribute_id=>wwv_flow_imp.id(10078314051254819)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10081225049254817)
,p_plugin_attribute_id=>wwv_flow_imp.id(10078314051254819)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10081800092254816)
,p_plugin_attribute_id=>wwv_flow_imp.id(10078314051254819)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(10082448221254816)
,p_plugin_attribute_id=>wwv_flow_imp.id(10078314051254819)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10083008138254815)
,p_plugin_id=>wwv_flow_imp.id(14227838373202985)
,p_attribute_scope=>'COMPONENT'
