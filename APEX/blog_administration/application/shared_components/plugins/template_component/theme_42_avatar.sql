...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(14227838373202985)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14228323612202996)
,p_plugin_id=>wwv_flow_imp.id(14227838373202985)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14228844424202997)
,p_plugin_attribute_id=>wwv_flow_imp.id(14228323612202996)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'IMAGE'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14229400821202999)
,p_plugin_attribute_id=>wwv_flow_imp.id(14228323612202996)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14230044088202999)
,p_plugin_attribute_id=>wwv_flow_imp.id(14228323612202996)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14230690965203000)
,p_plugin_id=>wwv_flow_imp.id(14227838373202985)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(14228323612202996)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14231105521203000)
,p_plugin_id=>wwv_flow_imp.id(14227838373202985)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(14230690965203000)
,p_depending_on_has_to_exist=>true
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14231619951203000)
,p_plugin_id=>wwv_flow_imp.id(14227838373202985)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14232141476203001)
,p_plugin_id=>wwv_flow_imp.id(14227838373202985)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14232631757203001)
,p_plugin_id=>wwv_flow_imp.id(14227838373202985)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14233182510203001)
,p_plugin_attribute_id=>wwv_flow_imp.id(14232631757203001)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14233733457203002)
,p_plugin_attribute_id=>wwv_flow_imp.id(14232631757203001)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14234322740203002)
,p_plugin_attribute_id=>wwv_flow_imp.id(14232631757203001)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14234905107203002)
,p_plugin_id=>wwv_flow_imp.id(14227838373202985)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14235405355203003)
,p_plugin_attribute_id=>wwv_flow_imp.id(14234905107203002)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14236029798203003)
,p_plugin_attribute_id=>wwv_flow_imp.id(14234905107203002)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14236691378203003)
,p_plugin_attribute_id=>wwv_flow_imp.id(14234905107203002)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14237298415203004)
,p_plugin_attribute_id=>wwv_flow_imp.id(14234905107203002)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14237886735203004)
,p_plugin_attribute_id=>wwv_flow_imp.id(14234905107203002)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14238400675203005)
,p_plugin_attribute_id=>wwv_flow_imp.id(14234905107203002)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14239008825203005)
,p_plugin_attribute_id=>wwv_flow_imp.id(14234905107203002)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14239666237203005)
,p_plugin_id=>wwv_flow_imp.id(14227838373202985)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1814278862959316739)
,p_plugin_id=>wwv_flow_imp.id(14227838373202985)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
