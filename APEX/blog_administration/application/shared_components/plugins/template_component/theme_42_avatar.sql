...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(96673961015035076)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74494717157825093)
,p_plugin_id=>wwv_flow_imp.id(96673961015035076)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74495233877825092)
,p_plugin_attribute_id=>wwv_flow_imp.id(74494717157825093)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'IMAGE'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74495864079825092)
,p_plugin_attribute_id=>wwv_flow_imp.id(74494717157825093)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74496452643825091)
,p_plugin_attribute_id=>wwv_flow_imp.id(74494717157825093)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74497076455825090)
,p_plugin_id=>wwv_flow_imp.id(96673961015035076)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(74494717157825093)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74497517968825089)
,p_plugin_id=>wwv_flow_imp.id(96673961015035076)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74498006304825089)
,p_plugin_id=>wwv_flow_imp.id(96673961015035076)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74498555318825088)
,p_plugin_id=>wwv_flow_imp.id(96673961015035076)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74499085733825087)
,p_plugin_id=>wwv_flow_imp.id(96673961015035076)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74499525039825087)
,p_plugin_attribute_id=>wwv_flow_imp.id(74499085733825087)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74500149914825086)
,p_plugin_attribute_id=>wwv_flow_imp.id(74499085733825087)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74500790312825085)
,p_plugin_attribute_id=>wwv_flow_imp.id(74499085733825087)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74501317904825085)
,p_plugin_attribute_id=>wwv_flow_imp.id(74499085733825087)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74501906447825084)
,p_plugin_id=>wwv_flow_imp.id(96673961015035076)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74502497083825083)
,p_plugin_attribute_id=>wwv_flow_imp.id(74501906447825084)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74503067141825082)
,p_plugin_attribute_id=>wwv_flow_imp.id(74501906447825084)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74503684698825082)
,p_plugin_attribute_id=>wwv_flow_imp.id(74501906447825084)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74504216871825081)
,p_plugin_attribute_id=>wwv_flow_imp.id(74501906447825084)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74504832725825080)
,p_plugin_attribute_id=>wwv_flow_imp.id(74501906447825084)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74505419499825080)
,p_plugin_attribute_id=>wwv_flow_imp.id(74501906447825084)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(74506087682825079)
,p_plugin_attribute_id=>wwv_flow_imp.id(74501906447825084)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(74506656106825077)
,p_plugin_id=>wwv_flow_imp.id(96673961015035076)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1896724985601148830)
,p_plugin_id=>wwv_flow_imp.id(96673961015035076)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
