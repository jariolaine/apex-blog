...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9025651908718167)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9026136172718168)
,p_plugin_attribute_id=>wwv_flow_imp.id(9025651908718167)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'IMAGE'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9026658967718169)
,p_plugin_attribute_id=>wwv_flow_imp.id(9025651908718167)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9027286088718170)
,p_plugin_attribute_id=>wwv_flow_imp.id(9025651908718167)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9027875098718171)
,p_plugin_id=>wwv_flow_imp.id(14227838373202985)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(9025651908718167)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9028362500718172)
,p_plugin_id=>wwv_flow_imp.id(14227838373202985)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9028839400718173)
,p_plugin_id=>wwv_flow_imp.id(14227838373202985)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9029362080718174)
,p_plugin_id=>wwv_flow_imp.id(14227838373202985)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9029801822718175)
,p_plugin_id=>wwv_flow_imp.id(14227838373202985)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9030366691718176)
,p_plugin_attribute_id=>wwv_flow_imp.id(9029801822718175)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9030967854718177)
,p_plugin_attribute_id=>wwv_flow_imp.id(9029801822718175)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9031511991718178)
,p_plugin_attribute_id=>wwv_flow_imp.id(9029801822718175)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9032118935718179)
,p_plugin_attribute_id=>wwv_flow_imp.id(9029801822718175)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9032723297718179)
,p_plugin_id=>wwv_flow_imp.id(14227838373202985)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9033222778718181)
,p_plugin_attribute_id=>wwv_flow_imp.id(9032723297718179)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9033815850718182)
,p_plugin_attribute_id=>wwv_flow_imp.id(9032723297718179)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9034453073718183)
,p_plugin_attribute_id=>wwv_flow_imp.id(9032723297718179)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9035082617718184)
,p_plugin_attribute_id=>wwv_flow_imp.id(9032723297718179)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9035677900718185)
,p_plugin_attribute_id=>wwv_flow_imp.id(9032723297718179)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9036280240718187)
,p_plugin_attribute_id=>wwv_flow_imp.id(9032723297718179)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9036827838718188)
,p_plugin_attribute_id=>wwv_flow_imp.id(9032723297718179)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9037424486718189)
,p_plugin_id=>wwv_flow_imp.id(14227838373202985)
,p_attribute_scope=>'COMPONENT'
