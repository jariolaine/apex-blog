...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(91639121750894734)
,p_theme_id=>42
,p_name=>'Drawer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74052817626825486)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74053382280825483)
,p_page_template_id=>wwv_flow_imp.id(91639121750894734)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74053849320825483)
,p_page_template_id=>wwv_flow_imp.id(91639121750894734)
