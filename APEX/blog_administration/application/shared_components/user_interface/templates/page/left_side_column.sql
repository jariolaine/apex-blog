...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9638368962255090)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9638858246255090)
,p_page_template_id=>wwv_flow_imp.id(8457924893518181)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9639360258255090)
,p_page_template_id=>wwv_flow_imp.id(8457924893518181)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9639818517255090)
,p_page_template_id=>wwv_flow_imp.id(8457924893518181)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9640300112255089)
,p_page_template_id=>wwv_flow_imp.id(8457924893518181)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9640860763255089)
,p_page_template_id=>wwv_flow_imp.id(8457924893518181)
,p_name=>'Left Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9641308597255089)
,p_page_template_id=>wwv_flow_imp.id(8457924893518181)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9641800035255089)
,p_page_template_id=>wwv_flow_imp.id(8457924893518181)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9642339686255088)
,p_page_template_id=>wwv_flow_imp.id(8457924893518181)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9642819805255088)
,p_page_template_id=>wwv_flow_imp.id(8457924893518181)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9643395872255088)
,p_page_template_id=>wwv_flow_imp.id(8457924893518181)
