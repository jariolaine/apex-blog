...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(90904047535350272)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74062955643825474)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74063407067825474)
,p_page_template_id=>wwv_flow_imp.id(90904047535350272)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74063992252825474)
,p_page_template_id=>wwv_flow_imp.id(90904047535350272)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74064435858825474)
,p_page_template_id=>wwv_flow_imp.id(90904047535350272)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74064903617825474)
,p_page_template_id=>wwv_flow_imp.id(90904047535350272)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74065443634825473)
,p_page_template_id=>wwv_flow_imp.id(90904047535350272)
,p_name=>'Left Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74065949341825473)
,p_page_template_id=>wwv_flow_imp.id(90904047535350272)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74066486003825473)
,p_page_template_id=>wwv_flow_imp.id(90904047535350272)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74066940087825473)
,p_page_template_id=>wwv_flow_imp.id(90904047535350272)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74067491912825473)
,p_page_template_id=>wwv_flow_imp.id(90904047535350272)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74067912646825472)
,p_page_template_id=>wwv_flow_imp.id(90904047535350272)
