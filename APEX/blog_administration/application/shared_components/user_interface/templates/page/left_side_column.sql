...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8594277563717788)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8594765907717789)
,p_page_template_id=>wwv_flow_imp.id(8457924893518181)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8595298524717789)
,p_page_template_id=>wwv_flow_imp.id(8457924893518181)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8595750817717789)
,p_page_template_id=>wwv_flow_imp.id(8457924893518181)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8596249141717790)
,p_page_template_id=>wwv_flow_imp.id(8457924893518181)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8596790594717790)
,p_page_template_id=>wwv_flow_imp.id(8457924893518181)
,p_name=>'Left Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8597241879717790)
,p_page_template_id=>wwv_flow_imp.id(8457924893518181)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8597729203717791)
,p_page_template_id=>wwv_flow_imp.id(8457924893518181)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8598221038717791)
,p_page_template_id=>wwv_flow_imp.id(8457924893518181)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8598771340717791)
,p_page_template_id=>wwv_flow_imp.id(8457924893518181)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8599253891717792)
,p_page_template_id=>wwv_flow_imp.id(8457924893518181)
