...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8605120795717796)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8605634946717796)
,p_page_template_id=>wwv_flow_imp.id(8463522862518184)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8606139676717796)
,p_page_template_id=>wwv_flow_imp.id(8463522862518184)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8606672197717797)
,p_page_template_id=>wwv_flow_imp.id(8463522862518184)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8607152523717797)
,p_page_template_id=>wwv_flow_imp.id(8463522862518184)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8607691966717797)
,p_page_template_id=>wwv_flow_imp.id(8463522862518184)
,p_name=>'Left Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8608161607717798)
,p_page_template_id=>wwv_flow_imp.id(8463522862518184)
,p_name=>'Right Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8608622486717798)
,p_page_template_id=>wwv_flow_imp.id(8463522862518184)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8609134397717798)
,p_page_template_id=>wwv_flow_imp.id(8463522862518184)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8609664544717799)
,p_page_template_id=>wwv_flow_imp.id(8463522862518184)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8610199558717799)
,p_page_template_id=>wwv_flow_imp.id(8463522862518184)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8610606539717799)
,p_page_template_id=>wwv_flow_imp.id(8463522862518184)
