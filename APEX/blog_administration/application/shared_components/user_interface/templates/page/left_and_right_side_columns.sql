...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9649275913255085)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9649708678255085)
,p_page_template_id=>wwv_flow_imp.id(8463522862518184)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9650259113255085)
,p_page_template_id=>wwv_flow_imp.id(8463522862518184)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9650766700255084)
,p_page_template_id=>wwv_flow_imp.id(8463522862518184)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9651278196255084)
,p_page_template_id=>wwv_flow_imp.id(8463522862518184)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9651706118255084)
,p_page_template_id=>wwv_flow_imp.id(8463522862518184)
,p_name=>'Left Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9652227040255083)
,p_page_template_id=>wwv_flow_imp.id(8463522862518184)
,p_name=>'Right Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9652720346255083)
,p_page_template_id=>wwv_flow_imp.id(8463522862518184)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9653273390255083)
,p_page_template_id=>wwv_flow_imp.id(8463522862518184)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9653714229255083)
,p_page_template_id=>wwv_flow_imp.id(8463522862518184)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9654226068255083)
,p_page_template_id=>wwv_flow_imp.id(8463522862518184)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9654772312255082)
,p_page_template_id=>wwv_flow_imp.id(8463522862518184)
