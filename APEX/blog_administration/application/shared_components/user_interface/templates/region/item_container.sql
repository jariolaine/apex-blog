...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(92476371318526461)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74299993300825220)
,p_plug_template_id=>wwv_flow_imp.id(92476371318526461)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74300466414825219)
,p_plug_template_id=>wwv_flow_imp.id(92476371318526461)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74300979728825219)
,p_plug_template_id=>wwv_flow_imp.id(92476371318526461)
,p_name=>'Button Start'
