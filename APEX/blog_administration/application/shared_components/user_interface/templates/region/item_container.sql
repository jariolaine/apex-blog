...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(10030248676694370)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14034310522202813)
,p_plug_template_id=>wwv_flow_imp.id(10030248676694370)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14034884437202813)
,p_plug_template_id=>wwv_flow_imp.id(10030248676694370)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14035379939202814)
,p_plug_template_id=>wwv_flow_imp.id(10030248676694370)
,p_name=>'Button Start'
