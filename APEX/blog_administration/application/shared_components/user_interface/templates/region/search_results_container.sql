...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(92472028137526459)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74312453425825213)
,p_plug_template_id=>wwv_flow_imp.id(92472028137526459)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74312983982825213)
,p_plug_template_id=>wwv_flow_imp.id(92472028137526459)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74313485728825212)
,p_plug_template_id=>wwv_flow_imp.id(92472028137526459)
,p_name=>'Sub Regions'
