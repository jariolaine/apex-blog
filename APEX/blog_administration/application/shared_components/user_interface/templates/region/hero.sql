...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(90938262348350298)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74235620813825259)
,p_plug_template_id=>wwv_flow_imp.id(90938262348350298)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74236132634825258)
,p_plug_template_id=>wwv_flow_imp.id(90938262348350298)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74236621239825258)
,p_plug_template_id=>wwv_flow_imp.id(90938262348350298)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74237197646825258)
,p_plug_template_id=>wwv_flow_imp.id(90938262348350298)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74237655867825258)
,p_plug_template_id=>wwv_flow_imp.id(90938262348350298)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
