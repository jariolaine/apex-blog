...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(90952353111350306)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74356374854825187)
,p_plug_template_id=>wwv_flow_imp.id(90952353111350306)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74356859983825187)
,p_plug_template_id=>wwv_flow_imp.id(90952353111350306)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74357369330825187)
,p_plug_template_id=>wwv_flow_imp.id(90952353111350306)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74357858901825187)
,p_plug_template_id=>wwv_flow_imp.id(90952353111350306)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74358392946825187)
,p_plug_template_id=>wwv_flow_imp.id(90952353111350306)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74358827030825186)
,p_plug_template_id=>wwv_flow_imp.id(90952353111350306)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74359367685825186)
,p_plug_template_id=>wwv_flow_imp.id(90952353111350306)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74359828713825186)
,p_plug_template_id=>wwv_flow_imp.id(90952353111350306)
,p_name=>'Help'
,p_placeholder=>'HELP'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74360390240825185)
,p_plug_template_id=>wwv_flow_imp.id(90952353111350306)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74360805990825185)
,p_plug_template_id=>wwv_flow_imp.id(90952353111350306)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74361360277825185)
,p_plug_template_id=>wwv_flow_imp.id(90952353111350306)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74361831242825185)
,p_plug_template_id=>wwv_flow_imp.id(90952353111350306)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74362336727825184)
,p_plug_template_id=>wwv_flow_imp.id(90952353111350306)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
