...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(28022413793030492)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(13902976525202722)
,p_plug_template_id=>wwv_flow_imp.id(28022413793030492)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(13903477613202722)
,p_plug_template_id=>wwv_flow_imp.id(28022413793030492)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(13903933432202722)
,p_plug_template_id=>wwv_flow_imp.id(28022413793030492)
,p_name=>'Sub Regions'
