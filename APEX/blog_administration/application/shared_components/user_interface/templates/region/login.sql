...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9882181119254953)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9882608097254953)
,p_plug_template_id=>wwv_flow_imp.id(8496352815518209)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9883138793254953)
,p_plug_template_id=>wwv_flow_imp.id(8496352815518209)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9883659976254952)
,p_plug_template_id=>wwv_flow_imp.id(8496352815518209)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9884131729254952)
,p_plug_template_id=>wwv_flow_imp.id(8496352815518209)
,p_name=>'Sub Regions'
