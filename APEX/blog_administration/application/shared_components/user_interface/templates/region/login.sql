...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8496352815518209)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14041138680202818)
,p_plug_template_id=>wwv_flow_imp.id(8496352815518209)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14041612034202818)
,p_plug_template_id=>wwv_flow_imp.id(8496352815518209)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14042149061202818)
,p_plug_template_id=>wwv_flow_imp.id(8496352815518209)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14042663343202818)
,p_plug_template_id=>wwv_flow_imp.id(8496352815518209)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(14043173963202819)
,p_plug_template_id=>wwv_flow_imp.id(8496352815518209)
,p_name=>'Sub Regions'
