...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8838085551717991)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8838504250717992)
,p_plug_template_id=>wwv_flow_imp.id(8496352815518209)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8839068318717992)
,p_plug_template_id=>wwv_flow_imp.id(8496352815518209)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8839576847717992)
,p_plug_template_id=>wwv_flow_imp.id(8496352815518209)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8840096128717992)
,p_plug_template_id=>wwv_flow_imp.id(8496352815518209)
,p_name=>'Sub Regions'
