...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(90942475457350300)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74306705735825216)
,p_plug_template_id=>wwv_flow_imp.id(90942475457350300)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74307274222825216)
,p_plug_template_id=>wwv_flow_imp.id(90942475457350300)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74307715255825216)
,p_plug_template_id=>wwv_flow_imp.id(90942475457350300)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74308250862825215)
,p_plug_template_id=>wwv_flow_imp.id(90942475457350300)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74308793697825215)
,p_plug_template_id=>wwv_flow_imp.id(90942475457350300)
,p_name=>'Sub Regions'
