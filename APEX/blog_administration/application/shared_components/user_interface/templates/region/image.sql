...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(92015593320718709)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74243112987825254)
,p_plug_template_id=>wwv_flow_imp.id(92015593320718709)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74243671350825254)
,p_plug_template_id=>wwv_flow_imp.id(92015593320718709)
,p_name=>'Sub Regions'
