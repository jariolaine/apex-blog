...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(9569470678886618)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(13977572628202777)
,p_plug_template_id=>wwv_flow_imp.id(9569470678886618)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(13978070890202777)
,p_plug_template_id=>wwv_flow_imp.id(9569470678886618)
,p_name=>'Sub Regions'
