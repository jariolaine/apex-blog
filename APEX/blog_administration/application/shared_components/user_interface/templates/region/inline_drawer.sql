...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(91836154696894896)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74270131072825237)
,p_plug_template_id=>wwv_flow_imp.id(91836154696894896)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74270681191825237)
,p_plug_template_id=>wwv_flow_imp.id(91836154696894896)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74271164934825237)
,p_plug_template_id=>wwv_flow_imp.id(91836154696894896)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74271606212825236)
,p_plug_template_id=>wwv_flow_imp.id(91836154696894896)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74272165317825236)
,p_plug_template_id=>wwv_flow_imp.id(91836154696894896)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74272673250825236)
,p_plug_template_id=>wwv_flow_imp.id(91836154696894896)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74273133176825236)
,p_plug_template_id=>wwv_flow_imp.id(91836154696894896)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74273662367825236)
,p_plug_template_id=>wwv_flow_imp.id(91836154696894896)
,p_name=>'Sub Regions'
