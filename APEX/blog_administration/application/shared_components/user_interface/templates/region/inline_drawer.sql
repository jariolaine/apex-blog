...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9845573766254974)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9846001545254974)
,p_plug_template_id=>wwv_flow_imp.id(9390032055062805)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9846516697254974)
,p_plug_template_id=>wwv_flow_imp.id(9390032055062805)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9847067999254974)
,p_plug_template_id=>wwv_flow_imp.id(9390032055062805)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9847588989254974)
,p_plug_template_id=>wwv_flow_imp.id(9390032055062805)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9848032264254973)
,p_plug_template_id=>wwv_flow_imp.id(9390032055062805)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9848533545254973)
,p_plug_template_id=>wwv_flow_imp.id(9390032055062805)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9849094026254973)
,p_plug_template_id=>wwv_flow_imp.id(9390032055062805)
,p_name=>'Sub Regions'
