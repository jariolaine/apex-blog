...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8801501224717955)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8802044005717955)
,p_plug_template_id=>wwv_flow_imp.id(9390032055062805)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8802599334717956)
,p_plug_template_id=>wwv_flow_imp.id(9390032055062805)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8803095302717956)
,p_plug_template_id=>wwv_flow_imp.id(9390032055062805)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8803518729717957)
,p_plug_template_id=>wwv_flow_imp.id(9390032055062805)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8804012110717957)
,p_plug_template_id=>wwv_flow_imp.id(9390032055062805)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8804526427717957)
,p_plug_template_id=>wwv_flow_imp.id(9390032055062805)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8805007968717958)
,p_plug_template_id=>wwv_flow_imp.id(9390032055062805)
,p_name=>'Sub Regions'
