...
,p_last_upd_yyyymmddhh24miss=>'20230321134251'
);
...
,p_column_html_expression=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<button title="#BTN_COPY_URL#" type="button" class="t-Button t-Button--noLabel t-Button--icon t-Button--small t-Button--stretch" onclick="void(0);" data-clipboard-source="#RELATIVE_PATH#">',
