...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(193594636939611774)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(193594748967611784)
,p_name=>'P20015_OCI_USER_OCID'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(193594636939611774)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(193595021611611786)
,p_name=>'P20015_OCI_PRIVATE_KEY'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(193594636939611774)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(193595103682611787)
,p_name=>'P20015_OCI_TENANCY_OCID'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_imp.id(193594636939611774)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(193595209314611788)
,p_name=>'P20015_OCI_PUBLIC_KEY_FINGERPRINT'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_imp.id(193594636939611774)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(96786565804172214)
,p_event_id=>wwv_flow_imp.id(114485227016989994)
,p_event_result=>'TRUE'
...
,p_affected_region_id=>wwv_flow_imp.id(193594636939611774)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(96786621820172215)
,p_event_id=>wwv_flow_imp.id(114485227016989994)
,p_event_result=>'FALSE'
,p_action_sequence=>30
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(96811010545442275)
...
':P20015_OCI_USER_OCID is not null and',
':P20015_OCI_PRIVATE_KEY is not null and',
':P20015_OCI_TENANCY_OCID is not null and',
':P20015_OCI_PUBLIC_KEY_FINGERPRINT is not null',
''))
,p_process_when_type=>'EXPRESSION'
,p_process_when2=>'PLSQL'
,p_process_success_message=>'Credential updated.'
,p_internal_uid=>96811010545442275
);
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(96811474660442279)
,p_page_process_id=>wwv_flow_imp.id(96811010545442275)
,p_page_id=>20015
...
,p_value_type=>'STATIC'
,p_value=>'BLOG_OCI_LANGUAGE_AI_API_KEY'
);
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(96811982526442279)
,p_page_process_id=>wwv_flow_imp.id(96811010545442275)
,p_page_id=>20015
,p_name=>'p_client_id'
,p_direction=>'IN'
...
,p_value_type=>'ITEM'
,p_value=>'P20015_OCI_USER_OCID'
);
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(96812444522442279)
,p_page_process_id=>wwv_flow_imp.id(96811010545442275)
,p_page_id=>20015
...
,p_value_type=>'ITEM'
,p_value=>'P20015_OCI_PRIVATE_KEY'
);
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(96812905856442280)
,p_page_process_id=>wwv_flow_imp.id(96811010545442275)
,p_page_id=>20015
,p_name=>'p_namespace'
,p_direction=>'IN'
...
,p_value_type=>'ITEM'
,p_value=>'P20015_OCI_TENANCY_OCID'
);
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(96813466242442280)
,p_page_process_id=>wwv_flow_imp.id(96811010545442275)
,p_page_id=>20015
...
,p_value_type=>'ITEM'
,p_value=>'P20015_OCI_PUBLIC_KEY_FINGERPRINT'
);
wwv_flow_imp_page.create_page_process(
