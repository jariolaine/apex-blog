...
insert into blog_init_items( is_active, application_id, item_name )
  select 1, apex_application_install.get_application_id, 'G_LATEST_POST_ROWS' from dual
where not exists( select 1 from blog_init_items where item_name = 'G_LATEST_POST_ROWS' );
--------------------------------------------------------
