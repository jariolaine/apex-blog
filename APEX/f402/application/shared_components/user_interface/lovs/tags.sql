...
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(13690460867369074)
,p_lov_name=>'TAGS'
...
wwv_flow_api.create_list_of_values_cols(
 p_id=>wwv_flow_api.id(13826303638635316)
...
wwv_flow_api.create_list_of_values_cols(
 p_id=>wwv_flow_api.id(13826691952635317)
...
wwv_flow_api.create_list_of_values_cols(
 p_id=>wwv_flow_api.id(13827000349635318)
