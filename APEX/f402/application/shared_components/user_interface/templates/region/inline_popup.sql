...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(9316330954062749)
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(9316816765062750)
,p_plug_template_id=>wwv_flow_api.id(5384973578146032)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(9317314866062750)
,p_plug_template_id=>wwv_flow_api.id(5384973578146032)
,p_name=>'Create'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(9317831892062750)
,p_plug_template_id=>wwv_flow_api.id(5384973578146032)
,p_name=>'Delete'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(9318379530062750)
,p_plug_template_id=>wwv_flow_api.id(5384973578146032)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(9318824592062751)
,p_plug_template_id=>wwv_flow_api.id(5384973578146032)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(9319334996062751)
,p_plug_template_id=>wwv_flow_api.id(5384973578146032)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(9319894547062751)
,p_plug_template_id=>wwv_flow_api.id(5384973578146032)
,p_name=>'Sub Regions'
