...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(9286185877062726)
,p_plug_template_id=>wwv_flow_api.id(8490381578518205)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(9286634051062727)
,p_plug_template_id=>wwv_flow_api.id(8490381578518205)
,p_name=>'Change'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(9287150675062727)
,p_plug_template_id=>wwv_flow_api.id(8490381578518205)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(9287614370062727)
,p_plug_template_id=>wwv_flow_api.id(8490381578518205)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(9288189278062727)
,p_plug_template_id=>wwv_flow_api.id(8490381578518205)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(9288647546062728)
,p_plug_template_id=>wwv_flow_api.id(8490381578518205)
,p_name=>'Sub Regions'
