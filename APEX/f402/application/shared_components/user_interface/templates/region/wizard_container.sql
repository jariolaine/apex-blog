...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(9386159362062802)
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(9386619646062802)
,p_plug_template_id=>wwv_flow_api.id(8507240237518215)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(9387128366062802)
,p_plug_template_id=>wwv_flow_api.id(8507240237518215)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(9387609613062803)
,p_plug_template_id=>wwv_flow_api.id(8507240237518215)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(9388130681062803)
,p_plug_template_id=>wwv_flow_api.id(8507240237518215)
