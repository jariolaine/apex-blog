...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(9200433438062658)
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(9200919453062659)
,p_plug_template_id=>wwv_flow_api.id(8471603023518189)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(9201448510062659)
,p_plug_template_id=>wwv_flow_api.id(8471603023518189)
,p_name=>'Create'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(9201911823062659)
,p_plug_template_id=>wwv_flow_api.id(8471603023518189)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(9202459670062659)
,p_plug_template_id=>wwv_flow_api.id(8471603023518189)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(9202979998062660)
,p_plug_template_id=>wwv_flow_api.id(8471603023518189)
,p_name=>'Sub Regions'
