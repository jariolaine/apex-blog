...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9427761080886516)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9428161798886516)
,p_plug_template_id=>wwv_flow_imp.id(8485724502518203)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9428661735886516)
,p_plug_template_id=>wwv_flow_imp.id(8485724502518203)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9429136447886516)
,p_plug_template_id=>wwv_flow_imp.id(8485724502518203)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9429611654886517)
,p_plug_template_id=>wwv_flow_imp.id(8485724502518203)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9430192486886517)
,p_plug_template_id=>wwv_flow_imp.id(8485724502518203)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9430685451886517)
,p_plug_template_id=>wwv_flow_imp.id(8485724502518203)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9431106719886517)
,p_plug_template_id=>wwv_flow_imp.id(8485724502518203)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9431667195886517)
,p_plug_template_id=>wwv_flow_imp.id(8485724502518203)
,p_name=>'Sub Regions'
