...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(9261634408062709)
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(9262154392062709)
,p_plug_template_id=>wwv_flow_api.id(8485724502518203)
,p_name=>'Change'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(9262611312062709)
,p_plug_template_id=>wwv_flow_api.id(8485724502518203)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(9263131876062709)
,p_plug_template_id=>wwv_flow_api.id(8485724502518203)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(9263677595062710)
,p_plug_template_id=>wwv_flow_api.id(8485724502518203)
,p_name=>'Create'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(9264128754062710)
,p_plug_template_id=>wwv_flow_api.id(8485724502518203)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(9264640698062710)
,p_plug_template_id=>wwv_flow_api.id(8485724502518203)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(9265164704062710)
,p_plug_template_id=>wwv_flow_api.id(8485724502518203)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(9265695553062711)
,p_plug_template_id=>wwv_flow_api.id(8485724502518203)
,p_name=>'Sub Regions'
