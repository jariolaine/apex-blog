...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(28022413793030492)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(9230308859062684)
,p_plug_template_id=>wwv_flow_api.id(28022413793030492)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(9230839237062684)
,p_plug_template_id=>wwv_flow_api.id(28022413793030492)
,p_name=>'Sub Regions'
