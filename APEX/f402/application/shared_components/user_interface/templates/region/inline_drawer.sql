...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9482155768886554)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9482600932886554)
,p_plug_template_id=>wwv_flow_imp.id(9390032055062805)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9483199057886555)
,p_plug_template_id=>wwv_flow_imp.id(9390032055062805)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9483682700886555)
,p_plug_template_id=>wwv_flow_imp.id(9390032055062805)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9484197242886555)
,p_plug_template_id=>wwv_flow_imp.id(9390032055062805)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9484616406886555)
,p_plug_template_id=>wwv_flow_imp.id(9390032055062805)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9485100157886556)
,p_plug_template_id=>wwv_flow_imp.id(9390032055062805)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(9485611223886556)
,p_plug_template_id=>wwv_flow_imp.id(9390032055062805)
,p_name=>'Sub Regions'
