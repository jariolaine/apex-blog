...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(9390032055062805)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(9390574077062808)
,p_plug_template_id=>wwv_flow_api.id(9390032055062805)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(9391037183062808)
,p_plug_template_id=>wwv_flow_api.id(9390032055062805)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(9391561787062809)
,p_plug_template_id=>wwv_flow_api.id(9390032055062805)
,p_name=>'Create'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(9392096749062809)
,p_plug_template_id=>wwv_flow_api.id(9390032055062805)
,p_name=>'Delete'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(9392598303062809)
,p_plug_template_id=>wwv_flow_api.id(9390032055062805)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(9393046924062810)
,p_plug_template_id=>wwv_flow_api.id(9390032055062805)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(9393542531062810)
,p_plug_template_id=>wwv_flow_api.id(9390032055062805)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(9394032614062810)
,p_plug_template_id=>wwv_flow_api.id(9390032055062805)
,p_name=>'Sub Regions'
