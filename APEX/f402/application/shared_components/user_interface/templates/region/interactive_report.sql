...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(9328842927062759)
,p_plug_template_id=>wwv_flow_api.id(8495746153518209)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(9329348840062759)
,p_plug_template_id=>wwv_flow_api.id(8495746153518209)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(9329826870062759)
,p_plug_template_id=>wwv_flow_api.id(8495746153518209)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(9330320006062760)
,p_plug_template_id=>wwv_flow_api.id(8495746153518209)
,p_name=>'Sub Regions'
