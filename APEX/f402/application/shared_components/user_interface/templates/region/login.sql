...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(9333719332062763)
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(9334256639062763)
,p_plug_template_id=>wwv_flow_api.id(8496352815518209)
,p_name=>'Create'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(9334776263062763)
,p_plug_template_id=>wwv_flow_api.id(8496352815518209)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(9335204624062764)
,p_plug_template_id=>wwv_flow_api.id(8496352815518209)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(9335726593062764)
,p_plug_template_id=>wwv_flow_api.id(8496352815518209)
,p_name=>'Sub Regions'
