...
,p_last_upd_yyyymmddhh24miss=>'20220717085026'
);
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(9552763746819315)
,p_plug_name=>'Buttons'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(6800417482545497)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(9552763746819315)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(6801215265545498)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(18315391113999516)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(6792001505545490)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(9551469694819302)
,p_name=>'P16_ID'
,p_source_data_type=>'NUMBER'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(9552054063819308)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(9552298169819310)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(18314847409999511)
,p_name=>'Close Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(6800417482545497)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(18314932830999512)
,p_event_id=>wwv_flow_imp.id(18314847409999511)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(18315229560999515)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_imp.id(6788182287545486)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(26968918134257317)
,p_process_sequence=>40
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
,p_process_name=>'File Deleted'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(6801215265545498)
,p_process_success_message=>'File deleted.'
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(26969048553257318)
,p_process_sequence=>50
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
,p_process_name=>'File Updated'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(18315391113999516)
,p_process_success_message=>'File attributes updated.'
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(6679986312771210)
