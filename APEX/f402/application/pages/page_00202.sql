...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(12513700970984043)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(12513831447984044)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(12514001878984046)
,p_query_column_id=>1
,p_column_alias=>'ATTRIBUTE_VALUE'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(12514150105984047)
,p_query_column_id=>2
,p_column_alias=>'CREATED_ON'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(12514210714984048)
,p_query_column_id=>3
,p_column_alias=>'CHANGED_ON'
,p_column_display_sequence=>30
,p_hidden_column=>'Y'
