...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(30331927761917804)
,p_plug_name=>'Buttons'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(20779498341098494)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(30331927761917804)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(20779776271098495)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(20750758141206616)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(20750366562206612)
,p_name=>'P22_FILE_NAME'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(20749984140206608)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(20780700866101698)
,p_name=>'Close Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(20779498341098494)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(20781184373101701)
,p_event_id=>wwv_flow_imp.id(20780700866101698)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(24909702684771836)
