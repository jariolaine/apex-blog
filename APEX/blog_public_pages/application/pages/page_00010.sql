...
,p_name=>'Links'
,p_alias=>'LINKS'
,p_step_title=>'Links | &P0_BLOG_APP_NAME.'
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(134293414371541424)
,p_name=>'Links'
...
,p_comment=>'See column HTML expression for icon_class column'
);
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(134327367873052780)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(134327147932052778)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(134326478882052771)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(134326706619052773)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(169272606146304461)
,p_query_column_id=>5
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(134327084011052777)
,p_query_column_id=>6
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(134326906384052775)
,p_query_column_id=>7
,p_column_alias=>'LINK'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(134327558377052782)
,p_query_column_id=>8
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(134326937640052776)
,p_query_column_id=>9
...
wwv_flow_imp_page.create_page_meta_tag(
 p_id=>wwv_flow_imp.id(168079470399157846)
,p_meta_tag_name=>'description'
,p_meta_tag_value=>'Useful links to other sites.'
);
wwv_flow_imp_page.create_page_meta_tag(
 p_id=>wwv_flow_imp.id(168079500774157847)
,p_meta_tag_name=>'og:description'
,p_meta_tag_value=>'Useful links to other sites.'
);
wwv_flow_imp_page.create_page_meta_tag(
 p_id=>wwv_flow_imp.id(168079616705157848)
,p_meta_tag_name=>'og:image'
,p_meta_tag_value=>'&APP_FILES.icons/app-icon-512.png'
);
wwv_flow_imp_page.create_page_meta_tag(
 p_id=>wwv_flow_imp.id(168079900426157851)
,p_meta_tag_name=>'og:title'
,p_meta_tag_value=>'Links | &P0_BLOG_APP_NAME.'
);
wwv_flow_imp_page.create_page_meta_tag(
 p_id=>wwv_flow_imp.id(168080051384157852)
,p_meta_tag_name=>'og:type'
,p_meta_tag_value=>'website'
);
wwv_flow_imp_page.create_page_meta_tag(
 p_id=>wwv_flow_imp.id(168081664777157868)
