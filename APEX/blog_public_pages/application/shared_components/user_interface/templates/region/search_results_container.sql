...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(136654216902452216)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(136355860831159962)
,p_plug_template_id=>wwv_flow_imp.id(136654216902452216)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(136356295082159961)
,p_plug_template_id=>wwv_flow_imp.id(136654216902452216)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(136356884078159961)
,p_plug_template_id=>wwv_flow_imp.id(136654216902452216)
,p_name=>'Sub Regions'
