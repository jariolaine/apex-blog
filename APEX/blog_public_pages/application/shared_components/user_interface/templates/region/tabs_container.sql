...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(134203704273163524)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(136389921400159940)
,p_plug_template_id=>wwv_flow_imp.id(134203704273163524)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(136390432862159940)
,p_plug_template_id=>wwv_flow_imp.id(134203704273163524)
,p_name=>'Tabs'
