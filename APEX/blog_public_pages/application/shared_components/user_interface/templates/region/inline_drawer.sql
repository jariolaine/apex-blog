...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8919478502263851)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8919943856263851)
,p_plug_template_id=>wwv_flow_imp.id(8601716414756970)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8920446463263851)
,p_plug_template_id=>wwv_flow_imp.id(8601716414756970)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8920904133263850)
,p_plug_template_id=>wwv_flow_imp.id(8601716414756970)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8921475311263850)
,p_plug_template_id=>wwv_flow_imp.id(8601716414756970)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8921922233263850)
,p_plug_template_id=>wwv_flow_imp.id(8601716414756970)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8922473561263850)
,p_plug_template_id=>wwv_flow_imp.id(8601716414756970)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8922931377263849)
,p_plug_template_id=>wwv_flow_imp.id(8601716414756970)
,p_name=>'Sub Regions'
