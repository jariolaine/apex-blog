...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7876790289709798)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7877210065709799)
,p_plug_template_id=>wwv_flow_imp.id(8601716414756970)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7877798567709799)
,p_plug_template_id=>wwv_flow_imp.id(8601716414756970)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7878230572709799)
,p_plug_template_id=>wwv_flow_imp.id(8601716414756970)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7878712965709800)
,p_plug_template_id=>wwv_flow_imp.id(8601716414756970)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7879285939709800)
,p_plug_template_id=>wwv_flow_imp.id(8601716414756970)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7879783577709800)
,p_plug_template_id=>wwv_flow_imp.id(8601716414756970)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7880203706709801)
,p_plug_template_id=>wwv_flow_imp.id(8601716414756970)
,p_name=>'Sub Regions'
