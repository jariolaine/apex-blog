...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(135995705743653104)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(136313467831159985)
,p_plug_template_id=>wwv_flow_imp.id(135995705743653104)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(136313933185159985)
,p_plug_template_id=>wwv_flow_imp.id(135995705743653104)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(136314435792159985)
,p_plug_template_id=>wwv_flow_imp.id(135995705743653104)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(136314893462159984)
,p_plug_template_id=>wwv_flow_imp.id(135995705743653104)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(136315464640159984)
,p_plug_template_id=>wwv_flow_imp.id(135995705743653104)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(136315911562159984)
,p_plug_template_id=>wwv_flow_imp.id(135995705743653104)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(136316462890159984)
,p_plug_template_id=>wwv_flow_imp.id(135995705743653104)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(136316920706159983)
,p_plug_template_id=>wwv_flow_imp.id(135995705743653104)
,p_name=>'Sub Regions'
