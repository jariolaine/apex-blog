...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7913351751709829)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7913896207709829)
,p_plug_template_id=>wwv_flow_imp.id(6802357267267386)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7914382162709829)
,p_plug_template_id=>wwv_flow_imp.id(6802357267267386)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7914808687709830)
,p_plug_template_id=>wwv_flow_imp.id(6802357267267386)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7915305477709830)
,p_plug_template_id=>wwv_flow_imp.id(6802357267267386)
,p_name=>'Sub Regions'
