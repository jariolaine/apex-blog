...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(134196346596163520)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(136349999579159965)
,p_plug_template_id=>wwv_flow_imp.id(134196346596163520)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(136350500707159965)
,p_plug_template_id=>wwv_flow_imp.id(134196346596163520)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(136351086571159964)
,p_plug_template_id=>wwv_flow_imp.id(134196346596163520)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(136351586588159964)
,p_plug_template_id=>wwv_flow_imp.id(134196346596163520)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(136352010836159964)
,p_plug_template_id=>wwv_flow_imp.id(134196346596163520)
,p_name=>'Sub Regions'
