...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(137656354539788534)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(136286436519160001)
,p_plug_template_id=>wwv_flow_imp.id(137656354539788534)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(136286901438160001)
,p_plug_template_id=>wwv_flow_imp.id(137656354539788534)
,p_name=>'Sub Regions'
