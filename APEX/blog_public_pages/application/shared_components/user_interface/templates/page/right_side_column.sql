...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7722436260709653)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7722927444709653)
,p_page_template_id=>wwv_flow_imp.id(6766836658267367)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7723406883709654)
,p_page_template_id=>wwv_flow_imp.id(6766836658267367)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7723946800709654)
,p_page_template_id=>wwv_flow_imp.id(6766836658267367)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7724417707709654)
,p_page_template_id=>wwv_flow_imp.id(6766836658267367)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7724961108709655)
,p_page_template_id=>wwv_flow_imp.id(6766836658267367)
,p_name=>'Right Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7725484860709655)
,p_page_template_id=>wwv_flow_imp.id(6766836658267367)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7725920901709656)
,p_page_template_id=>wwv_flow_imp.id(6766836658267367)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7726461530709656)
,p_page_template_id=>wwv_flow_imp.id(6766836658267367)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7726988207709656)
,p_page_template_id=>wwv_flow_imp.id(6766836658267367)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7727411255709657)
,p_page_template_id=>wwv_flow_imp.id(6766836658267367)
