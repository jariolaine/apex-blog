...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(135798725794652931)
,p_theme_id=>42
,p_name=>'Drawer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(136096236077160133)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(136096770726160133)
,p_page_template_id=>wwv_flow_imp.id(135798725794652931)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(136097193692160132)
,p_page_template_id=>wwv_flow_imp.id(135798725794652931)
