...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(142512854813105316)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1936452385142191447)
,p_plugin_id=>wwv_flow_imp.id(142512854813105316)
,p_title=>'Avatar'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136567671808159729)
,p_plugin_id=>wwv_flow_imp.id(142512854813105316)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136568153973159728)
,p_plugin_id=>wwv_flow_imp.id(142512854813105316)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136568651787159728)
,p_plugin_id=>wwv_flow_imp.id(142512854813105316)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136569110360159727)
,p_plugin_id=>wwv_flow_imp.id(142512854813105316)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136569596982159727)
,p_plugin_id=>wwv_flow_imp.id(142512854813105316)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(136576883336159719)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1936452385142191447)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136570165449159726)
,p_plugin_attribute_id=>wwv_flow_imp.id(136569596982159727)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136570704525159725)
,p_plugin_attribute_id=>wwv_flow_imp.id(136569596982159727)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136571345326159725)
,p_plugin_attribute_id=>wwv_flow_imp.id(136569596982159727)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136571980518159724)
,p_plugin_id=>wwv_flow_imp.id(142512854813105316)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(136569596982159727)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136572482366159724)
,p_plugin_id=>wwv_flow_imp.id(142512854813105316)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136572959637159723)
,p_plugin_id=>wwv_flow_imp.id(142512854813105316)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136573411590159723)
,p_plugin_id=>wwv_flow_imp.id(142512854813105316)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136573910246159722)
,p_plugin_id=>wwv_flow_imp.id(142512854813105316)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136576283337159720)
,p_plugin_attribute_id=>wwv_flow_imp.id(136573910246159722)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136574398295159722)
,p_plugin_attribute_id=>wwv_flow_imp.id(136573910246159722)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136575027728159721)
,p_plugin_attribute_id=>wwv_flow_imp.id(136573910246159722)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136575642941159720)
,p_plugin_attribute_id=>wwv_flow_imp.id(136573910246159722)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136576883336159719)
,p_plugin_id=>wwv_flow_imp.id(142512854813105316)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136577328345159719)
,p_plugin_id=>wwv_flow_imp.id(142512854813105316)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136577887153159718)
,p_plugin_id=>wwv_flow_imp.id(142512854813105316)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136578370153159718)
,p_plugin_attribute_id=>wwv_flow_imp.id(136577887153159718)
,p_display_sequence=>10
,p_display_value=>'Basic'
,p_return_value=>'t-Comments--basic'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136578969316159717)
,p_plugin_attribute_id=>wwv_flow_imp.id(136577887153159718)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136579514440159716)
,p_plugin_id=>wwv_flow_imp.id(142512854813105316)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1942531197200238536)
,p_plugin_id=>wwv_flow_imp.id(142512854813105316)
,p_name=>'Link'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1942530605695231079)
,p_plugin_id=>wwv_flow_imp.id(142512854813105316)
,p_name=>'Actions'
,p_static_id=>'ACTIONS'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1942586229365212958)
,p_plugin_id=>wwv_flow_imp.id(142512854813105316)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1942738447078083729)
,p_plugin_id=>wwv_flow_imp.id(142512854813105316)
