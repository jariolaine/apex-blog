...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(142489274203105300)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136538819010159783)
,p_plugin_id=>wwv_flow_imp.id(142489274203105300)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136539333664159782)
,p_plugin_attribute_id=>wwv_flow_imp.id(136538819010159783)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'IMAGE'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136539974342159781)
,p_plugin_attribute_id=>wwv_flow_imp.id(136538819010159783)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136540534136159780)
,p_plugin_attribute_id=>wwv_flow_imp.id(136538819010159783)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136541177562159779)
,p_plugin_id=>wwv_flow_imp.id(142489274203105300)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(136538819010159783)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136541667066159778)
,p_plugin_id=>wwv_flow_imp.id(142489274203105300)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136542104450159778)
,p_plugin_id=>wwv_flow_imp.id(142489274203105300)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136542660126159778)
,p_plugin_id=>wwv_flow_imp.id(142489274203105300)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136543180416159777)
,p_plugin_id=>wwv_flow_imp.id(142489274203105300)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136543591022159777)
,p_plugin_attribute_id=>wwv_flow_imp.id(136543180416159777)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136544251978159776)
,p_plugin_attribute_id=>wwv_flow_imp.id(136543180416159777)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136544846670159776)
,p_plugin_attribute_id=>wwv_flow_imp.id(136543180416159777)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136545480223159775)
,p_plugin_attribute_id=>wwv_flow_imp.id(136543180416159777)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136546033316159775)
,p_plugin_id=>wwv_flow_imp.id(142489274203105300)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136546584284159774)
,p_plugin_attribute_id=>wwv_flow_imp.id(136546033316159775)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136547123401159771)
,p_plugin_attribute_id=>wwv_flow_imp.id(136546033316159775)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136547715933159771)
,p_plugin_attribute_id=>wwv_flow_imp.id(136546033316159775)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136548293583159769)
,p_plugin_attribute_id=>wwv_flow_imp.id(136546033316159775)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136548957820159769)
,p_plugin_attribute_id=>wwv_flow_imp.id(136546033316159775)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136549556619159768)
,p_plugin_attribute_id=>wwv_flow_imp.id(136546033316159775)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136550176171159768)
,p_plugin_attribute_id=>wwv_flow_imp.id(136546033316159775)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136550781595159767)
,p_plugin_id=>wwv_flow_imp.id(142489274203105300)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1942540336245219053)
,p_plugin_id=>wwv_flow_imp.id(142489274203105300)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
