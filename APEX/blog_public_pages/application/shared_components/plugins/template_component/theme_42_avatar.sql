...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9144829681263649)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9145344335263648)
,p_plugin_attribute_id=>wwv_flow_imp.id(9144829681263649)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'IMAGE'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9145985013263647)
,p_plugin_attribute_id=>wwv_flow_imp.id(9144829681263649)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9146544807263646)
,p_plugin_attribute_id=>wwv_flow_imp.id(9144829681263649)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9147188233263645)
,p_plugin_id=>wwv_flow_imp.id(15095284874209166)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(9144829681263649)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9147677737263644)
,p_plugin_id=>wwv_flow_imp.id(15095284874209166)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9148115121263644)
,p_plugin_id=>wwv_flow_imp.id(15095284874209166)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9148670797263644)
,p_plugin_id=>wwv_flow_imp.id(15095284874209166)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9149191087263643)
,p_plugin_id=>wwv_flow_imp.id(15095284874209166)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9149601693263643)
,p_plugin_attribute_id=>wwv_flow_imp.id(9149191087263643)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9150262649263642)
,p_plugin_attribute_id=>wwv_flow_imp.id(9149191087263643)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9150857341263642)
,p_plugin_attribute_id=>wwv_flow_imp.id(9149191087263643)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9151490894263641)
,p_plugin_attribute_id=>wwv_flow_imp.id(9149191087263643)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9152043987263641)
,p_plugin_id=>wwv_flow_imp.id(15095284874209166)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9152594955263640)
,p_plugin_attribute_id=>wwv_flow_imp.id(9152043987263641)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9153134072263637)
,p_plugin_attribute_id=>wwv_flow_imp.id(9152043987263641)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9153726604263637)
,p_plugin_attribute_id=>wwv_flow_imp.id(9152043987263641)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9154304254263635)
,p_plugin_attribute_id=>wwv_flow_imp.id(9152043987263641)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9154968491263635)
,p_plugin_attribute_id=>wwv_flow_imp.id(9152043987263641)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9155567290263634)
,p_plugin_attribute_id=>wwv_flow_imp.id(9152043987263641)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9156186842263634)
,p_plugin_attribute_id=>wwv_flow_imp.id(9152043987263641)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9156792266263633)
,p_plugin_id=>wwv_flow_imp.id(15095284874209166)
,p_attribute_scope=>'COMPONENT'
