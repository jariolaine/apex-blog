...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(142529635215105328)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136562806725159739)
,p_plugin_id=>wwv_flow_imp.id(142529635215105328)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136563386647159739)
,p_plugin_id=>wwv_flow_imp.id(142529635215105328)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136563859857159738)
,p_plugin_id=>wwv_flow_imp.id(142529635215105328)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136564385245159738)
,p_plugin_id=>wwv_flow_imp.id(142529635215105328)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136564807169159737)
,p_plugin_id=>wwv_flow_imp.id(142529635215105328)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136565328142159737)
,p_plugin_id=>wwv_flow_imp.id(142529635215105328)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136565862780159736)
,p_plugin_id=>wwv_flow_imp.id(142529635215105328)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136566310908159736)
,p_plugin_id=>wwv_flow_imp.id(142529635215105328)
,p_attribute_scope=>'COMPONENT'
