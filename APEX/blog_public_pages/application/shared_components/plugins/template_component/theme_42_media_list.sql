...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(142597362060105373)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1936647257828043296)
,p_plugin_id=>wwv_flow_imp.id(142597362060105373)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1936646702816043295)
,p_plugin_id=>wwv_flow_imp.id(142597362060105373)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136629947766159645)
,p_plugin_id=>wwv_flow_imp.id(142597362060105373)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136630458572159644)
,p_plugin_id=>wwv_flow_imp.id(142597362060105373)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136630949004159644)
,p_plugin_id=>wwv_flow_imp.id(142597362060105373)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136631417911159643)
,p_plugin_id=>wwv_flow_imp.id(142597362060105373)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136631907584159643)
,p_plugin_id=>wwv_flow_imp.id(142597362060105373)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(136630949004159644)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1936647257828043296)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136632454553159642)
,p_plugin_attribute_id=>wwv_flow_imp.id(136631907584159643)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136633027820159642)
,p_plugin_attribute_id=>wwv_flow_imp.id(136631907584159643)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136633627769159641)
,p_plugin_attribute_id=>wwv_flow_imp.id(136631907584159643)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136634253633159641)
,p_plugin_id=>wwv_flow_imp.id(142597362060105373)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(136631907584159643)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136634778425159640)
,p_plugin_id=>wwv_flow_imp.id(142597362060105373)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136635199459159640)
,p_plugin_id=>wwv_flow_imp.id(142597362060105373)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136635751415159639)
,p_plugin_id=>wwv_flow_imp.id(142597362060105373)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136636279902159639)
,p_plugin_id=>wwv_flow_imp.id(142597362060105373)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136636689360159638)
,p_plugin_attribute_id=>wwv_flow_imp.id(136636279902159639)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136637317924159638)
,p_plugin_attribute_id=>wwv_flow_imp.id(136636279902159639)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136637921468159637)
,p_plugin_attribute_id=>wwv_flow_imp.id(136636279902159639)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136638515782159636)
,p_plugin_attribute_id=>wwv_flow_imp.id(136636279902159639)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136639152425159636)
,p_plugin_id=>wwv_flow_imp.id(142597362060105373)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'RAW'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(136631417911159643)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(1936646702816043295)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136639654508159635)
,p_plugin_id=>wwv_flow_imp.id(142597362060105373)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136640177889159635)
,p_plugin_id=>wwv_flow_imp.id(142597362060105373)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136640637333159634)
,p_plugin_id=>wwv_flow_imp.id(142597362060105373)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136641184392159634)
,p_plugin_id=>wwv_flow_imp.id(142597362060105373)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136641629027159633)
,p_plugin_id=>wwv_flow_imp.id(142597362060105373)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136642143087159633)
,p_plugin_attribute_id=>wwv_flow_imp.id(136641629027159633)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136642735692159632)
,p_plugin_attribute_id=>wwv_flow_imp.id(136641629027159633)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136643377361159632)
,p_plugin_id=>wwv_flow_imp.id(142597362060105373)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136643835520159631)
,p_plugin_attribute_id=>wwv_flow_imp.id(136643377361159632)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136644474428159631)
,p_plugin_attribute_id=>wwv_flow_imp.id(136643377361159632)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136645083193159630)
,p_plugin_attribute_id=>wwv_flow_imp.id(136643377361159632)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136645653191159629)
,p_plugin_id=>wwv_flow_imp.id(142597362060105373)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136646090761159629)
,p_plugin_attribute_id=>wwv_flow_imp.id(136645653191159629)
,p_display_sequence=>10
,p_display_value=>'2 Column Grid'
,p_return_value=>'t-MediaList--cols t-MediaList--2cols'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136646699545159628)
,p_plugin_attribute_id=>wwv_flow_imp.id(136645653191159629)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136647350952159628)
,p_plugin_attribute_id=>wwv_flow_imp.id(136645653191159629)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136647939635159627)
,p_plugin_attribute_id=>wwv_flow_imp.id(136645653191159629)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136648579336159627)
,p_plugin_attribute_id=>wwv_flow_imp.id(136645653191159629)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136649117097159626)
,p_plugin_id=>wwv_flow_imp.id(142597362060105373)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136649639970159626)
,p_plugin_attribute_id=>wwv_flow_imp.id(136649117097159626)
,p_display_sequence=>10
,p_display_value=>'Large'
,p_return_value=>'t-MediaList--large force-fa-lg'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136650198427159625)
,p_plugin_id=>wwv_flow_imp.id(142597362060105373)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1942818960463135651)
,p_plugin_id=>wwv_flow_imp.id(142597362060105373)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
