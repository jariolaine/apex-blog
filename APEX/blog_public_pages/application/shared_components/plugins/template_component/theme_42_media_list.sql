...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1809253268499147162)
,p_plugin_id=>wwv_flow_imp.id(15203372731209239)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1809252713487147161)
,p_plugin_id=>wwv_flow_imp.id(15203372731209239)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9235958437263511)
,p_plugin_id=>wwv_flow_imp.id(15203372731209239)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9236469243263510)
,p_plugin_id=>wwv_flow_imp.id(15203372731209239)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9236959675263510)
,p_plugin_id=>wwv_flow_imp.id(15203372731209239)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9237428582263509)
,p_plugin_id=>wwv_flow_imp.id(15203372731209239)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9237918255263509)
,p_plugin_id=>wwv_flow_imp.id(15203372731209239)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(9236959675263510)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1809253268499147162)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9238465224263508)
,p_plugin_attribute_id=>wwv_flow_imp.id(9237918255263509)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9239038491263508)
,p_plugin_attribute_id=>wwv_flow_imp.id(9237918255263509)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9239638440263507)
,p_plugin_attribute_id=>wwv_flow_imp.id(9237918255263509)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9240264304263507)
,p_plugin_id=>wwv_flow_imp.id(15203372731209239)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(9237918255263509)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9240789096263506)
,p_plugin_id=>wwv_flow_imp.id(15203372731209239)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9241210130263506)
,p_plugin_id=>wwv_flow_imp.id(15203372731209239)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9241762086263505)
,p_plugin_id=>wwv_flow_imp.id(15203372731209239)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9242290573263505)
,p_plugin_id=>wwv_flow_imp.id(15203372731209239)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9242700031263504)
,p_plugin_attribute_id=>wwv_flow_imp.id(9242290573263505)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9243328595263504)
,p_plugin_attribute_id=>wwv_flow_imp.id(9242290573263505)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9243932139263503)
,p_plugin_attribute_id=>wwv_flow_imp.id(9242290573263505)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9244526453263502)
,p_plugin_attribute_id=>wwv_flow_imp.id(9242290573263505)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9245163096263502)
,p_plugin_id=>wwv_flow_imp.id(15203372731209239)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'RAW'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(9237428582263509)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(1809252713487147161)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9245665179263501)
,p_plugin_id=>wwv_flow_imp.id(15203372731209239)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9246188560263501)
,p_plugin_id=>wwv_flow_imp.id(15203372731209239)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9246648004263500)
,p_plugin_id=>wwv_flow_imp.id(15203372731209239)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9247195063263500)
,p_plugin_id=>wwv_flow_imp.id(15203372731209239)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9247639698263499)
,p_plugin_id=>wwv_flow_imp.id(15203372731209239)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9248153758263499)
,p_plugin_attribute_id=>wwv_flow_imp.id(9247639698263499)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9248746363263498)
,p_plugin_attribute_id=>wwv_flow_imp.id(9247639698263499)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9249388032263498)
,p_plugin_id=>wwv_flow_imp.id(15203372731209239)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9249846191263497)
,p_plugin_attribute_id=>wwv_flow_imp.id(9249388032263498)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9250485099263497)
,p_plugin_attribute_id=>wwv_flow_imp.id(9249388032263498)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9251093864263496)
,p_plugin_attribute_id=>wwv_flow_imp.id(9249388032263498)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9251663862263495)
,p_plugin_id=>wwv_flow_imp.id(15203372731209239)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9252101432263495)
,p_plugin_attribute_id=>wwv_flow_imp.id(9251663862263495)
,p_display_sequence=>10
,p_display_value=>'2 Column Grid'
,p_return_value=>'t-MediaList--cols t-MediaList--2cols'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9252710216263494)
,p_plugin_attribute_id=>wwv_flow_imp.id(9251663862263495)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9253361623263494)
,p_plugin_attribute_id=>wwv_flow_imp.id(9251663862263495)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9253950306263493)
,p_plugin_attribute_id=>wwv_flow_imp.id(9251663862263495)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9254590007263493)
,p_plugin_attribute_id=>wwv_flow_imp.id(9251663862263495)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9255127768263492)
,p_plugin_id=>wwv_flow_imp.id(15203372731209239)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(9255650641263492)
,p_plugin_attribute_id=>wwv_flow_imp.id(9255127768263492)
,p_display_sequence=>10
,p_display_value=>'Large'
,p_return_value=>'t-MediaList--large force-fa-lg'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(9256209098263491)
,p_plugin_id=>wwv_flow_imp.id(15203372731209239)
,p_attribute_scope=>'REPORT'
