...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(142560124563105349)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2063821438457231397)
,p_plugin_id=>wwv_flow_imp.id(142560124563105349)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2063820883445231396)
,p_plugin_id=>wwv_flow_imp.id(142560124563105349)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1806928819714957883)
,p_plugin_id=>wwv_flow_imp.id(142560124563105349)
,p_title=>'Appearance'
,p_display_sequence=>30
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136585182585159698)
,p_plugin_id=>wwv_flow_imp.id(142560124563105349)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136585647830159696)
,p_plugin_id=>wwv_flow_imp.id(142560124563105349)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136586139609159695)
,p_plugin_id=>wwv_flow_imp.id(142560124563105349)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136586651295159695)
,p_plugin_id=>wwv_flow_imp.id(142560124563105349)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136587123259159694)
,p_plugin_id=>wwv_flow_imp.id(142560124563105349)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136587666844159693)
,p_plugin_id=>wwv_flow_imp.id(142560124563105349)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136588178252159693)
,p_plugin_id=>wwv_flow_imp.id(142560124563105349)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(136587123259159694)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(2063821438457231397)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136588647562159692)
,p_plugin_attribute_id=>wwv_flow_imp.id(136588178252159693)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136589206883159692)
,p_plugin_attribute_id=>wwv_flow_imp.id(136588178252159693)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136589802179159691)
,p_plugin_attribute_id=>wwv_flow_imp.id(136588178252159693)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136590400806159691)
,p_plugin_id=>wwv_flow_imp.id(142560124563105349)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(136588178252159693)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136590918538159690)
,p_plugin_id=>wwv_flow_imp.id(142560124563105349)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136591432422159690)
,p_plugin_id=>wwv_flow_imp.id(142560124563105349)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136591958028159689)
,p_plugin_id=>wwv_flow_imp.id(142560124563105349)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136592442985159688)
,p_plugin_id=>wwv_flow_imp.id(142560124563105349)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136592894988159688)
,p_plugin_attribute_id=>wwv_flow_imp.id(136592442985159688)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136593494294159687)
,p_plugin_attribute_id=>wwv_flow_imp.id(136592442985159688)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136594126366159687)
,p_plugin_attribute_id=>wwv_flow_imp.id(136592442985159688)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136594727496159686)
,p_plugin_attribute_id=>wwv_flow_imp.id(136592442985159688)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136595294543159686)
,p_plugin_id=>wwv_flow_imp.id(142560124563105349)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'RAW'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(136587666844159693)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(2063820883445231396)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136595880717159685)
,p_plugin_id=>wwv_flow_imp.id(142560124563105349)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136596309387159684)
,p_plugin_id=>wwv_flow_imp.id(142560124563105349)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136596820441159684)
,p_plugin_id=>wwv_flow_imp.id(142560124563105349)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136597320566159684)
,p_plugin_id=>wwv_flow_imp.id(142560124563105349)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136597842635159683)
,p_plugin_id=>wwv_flow_imp.id(142560124563105349)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136598306372159683)
,p_plugin_attribute_id=>wwv_flow_imp.id(136597842635159683)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136598953896159682)
,p_plugin_attribute_id=>wwv_flow_imp.id(136597842635159683)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136599521496159682)
,p_plugin_id=>wwv_flow_imp.id(142560124563105349)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136600053711159681)
,p_plugin_attribute_id=>wwv_flow_imp.id(136599521496159682)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136600686353159681)
,p_plugin_attribute_id=>wwv_flow_imp.id(136599521496159682)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136601190872159680)
,p_plugin_attribute_id=>wwv_flow_imp.id(136599521496159682)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136601799653159680)
,p_plugin_attribute_id=>wwv_flow_imp.id(136599521496159682)
,p_display_sequence=>40
,p_display_value=>'No Shape'
,p_return_value=>'t-Avatar--noShape'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136602457521159679)
,p_plugin_id=>wwv_flow_imp.id(142560124563105349)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136602891980159679)
,p_plugin_attribute_id=>wwv_flow_imp.id(136602457521159679)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136603535953159678)
,p_plugin_attribute_id=>wwv_flow_imp.id(136602457521159679)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136604144071159678)
,p_plugin_attribute_id=>wwv_flow_imp.id(136602457521159679)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136604704884159677)
,p_plugin_attribute_id=>wwv_flow_imp.id(136602457521159679)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136605351529159676)
,p_plugin_attribute_id=>wwv_flow_imp.id(136602457521159679)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136605890030159675)
,p_plugin_attribute_id=>wwv_flow_imp.id(136602457521159679)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136606561002159675)
,p_plugin_attribute_id=>wwv_flow_imp.id(136602457521159679)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136607095146159674)
,p_plugin_id=>wwv_flow_imp.id(142560124563105349)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136607658899159674)
,p_plugin_attribute_id=>wwv_flow_imp.id(136607095146159674)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-Badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136608284126159673)
,p_plugin_attribute_id=>wwv_flow_imp.id(136607095146159674)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136608823198159673)
,p_plugin_attribute_id=>wwv_flow_imp.id(136607095146159674)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136609419511159672)
,p_plugin_id=>wwv_flow_imp.id(142560124563105349)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136609909638159672)
,p_plugin_attribute_id=>wwv_flow_imp.id(136609419511159672)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-ContentRow-badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136610545587159671)
,p_plugin_attribute_id=>wwv_flow_imp.id(136609419511159672)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136611105986159671)
,p_plugin_attribute_id=>wwv_flow_imp.id(136609419511159672)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136611706392159670)
,p_plugin_attribute_id=>wwv_flow_imp.id(136609419511159672)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136612292066159670)
,p_plugin_id=>wwv_flow_imp.id(142560124563105349)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136612860244159669)
,p_plugin_attribute_id=>wwv_flow_imp.id(136612292066159670)
,p_display_sequence=>10
,p_display_value=>'End'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136613475560159669)
,p_plugin_id=>wwv_flow_imp.id(142560124563105349)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136613960527159668)
,p_plugin_attribute_id=>wwv_flow_imp.id(136613475560159669)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136614544942159668)
,p_plugin_attribute_id=>wwv_flow_imp.id(136613475560159669)
,p_display_sequence=>20
,p_display_value=>'End'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136615150371159667)
,p_plugin_id=>wwv_flow_imp.id(142560124563105349)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136615590416159667)
,p_plugin_id=>wwv_flow_imp.id(142560124563105349)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136616125249159667)
,p_plugin_id=>wwv_flow_imp.id(142560124563105349)
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_attribute_group_id=>wwv_flow_imp.id(1806928819714957883)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136616652918159666)
,p_plugin_id=>wwv_flow_imp.id(142560124563105349)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(136617179402159666)
,p_plugin_attribute_id=>wwv_flow_imp.id(136616652918159666)
,p_display_sequence=>10
,p_display_value=>'Compact'
,p_return_value=>'t-ContentRow--styleCompact'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136617774806159665)
,p_plugin_id=>wwv_flow_imp.id(142560124563105349)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(136618231140159665)
,p_plugin_id=>wwv_flow_imp.id(142560124563105349)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1951012023142998658)
,p_plugin_id=>wwv_flow_imp.id(142560124563105349)
,p_name=>'Button'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1951013282663002806)
,p_plugin_id=>wwv_flow_imp.id(142560124563105349)
,p_name=>'Menu'
,p_type=>'MENU'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1647040018862741199)
,p_plugin_id=>wwv_flow_imp.id(142560124563105349)
,p_name=>'Badge Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1937418394468591925)
,p_plugin_id=>wwv_flow_imp.id(142560124563105349)
,p_name=>'Title Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1938097695198675029)
,p_plugin_id=>wwv_flow_imp.id(142560124563105349)
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1951010088075953672)
,p_plugin_id=>wwv_flow_imp.id(142560124563105349)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1951011421465967529)
,p_plugin_id=>wwv_flow_imp.id(142560124563105349)
