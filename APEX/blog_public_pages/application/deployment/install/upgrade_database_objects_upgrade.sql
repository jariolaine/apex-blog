...
'--    such'))
,p_updated_on=>wwv_flow_imp.dz('20260125213126Z')
);
wwv_flow_imp_shared.append_to_install_script(
 p_id=>wwv_flow_imp.id(138405351815225809)
,p_script_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
' as posts, categories, archives, tags, and dynamic pages,',
...
wwv_flow_imp_shared.append_to_install_script(
 p_id=>wwv_flow_imp.id(138405351815225809)
,p_script_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'cation/vnd.ms-powerpoint.addin.macroenabled.12'';',
...
'    p_plugin  in            apex_plugin.t_plugin,',
'    p_param   in            apex_plugin.t_item_render_param,',
'    p_result  in out nocopy apex_plugin.t_item'))
);
wwv_flow_imp_shared.append_to_install_script(
 p_id=>wwv_flow_imp.id(138405351815225809)
,p_script_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.append_to_install_script(
 p_id=>wwv_flow_imp.id(138405351815225809)
,p_script_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'repare return validation error message',
...
'    then',
'',
'      apex_debug.info( ''Set compartment OCID: %s'', p_compartmen'))
);
end;
/
begin
