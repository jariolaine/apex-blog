...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8412116313756822)
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8412625021756822)
,p_plug_template_id=>wwv_flow_api.id(6777727951267373)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8413192534756823)
,p_plug_template_id=>wwv_flow_api.id(6777727951267373)
,p_name=>'Create'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8413630110756823)
,p_plug_template_id=>wwv_flow_api.id(6777727951267373)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8414143862756823)
,p_plug_template_id=>wwv_flow_api.id(6777727951267373)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8414608250756823)
,p_plug_template_id=>wwv_flow_api.id(6777727951267373)
,p_name=>'Sub Regions'
