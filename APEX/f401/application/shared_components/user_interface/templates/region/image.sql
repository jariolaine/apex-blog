...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(10262365210892400)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10262867260892400)
,p_plug_template_id=>wwv_flow_imp.id(10262365210892400)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10263331041892401)
,p_plug_template_id=>wwv_flow_imp.id(10262365210892400)
,p_name=>'Sub Regions'
