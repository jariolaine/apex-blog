...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10154147793892333)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10154603619892334)
,p_plug_template_id=>wwv_flow_imp.id(6798176791267383)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10155179879892334)
,p_plug_template_id=>wwv_flow_imp.id(6798176791267383)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10155670330892334)
,p_plug_template_id=>wwv_flow_imp.id(6798176791267383)
,p_name=>'Sub Regions'
