...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10120457916892311)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10120914665892311)
,p_plug_template_id=>wwv_flow_imp.id(6791752177267380)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10121420201892312)
,p_plug_template_id=>wwv_flow_imp.id(6791752177267380)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10121935958892312)
,p_plug_template_id=>wwv_flow_imp.id(6791752177267380)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10122439946892312)
,p_plug_template_id=>wwv_flow_imp.id(6791752177267380)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10122910976892312)
,p_plug_template_id=>wwv_flow_imp.id(6791752177267380)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10123422459892313)
,p_plug_template_id=>wwv_flow_imp.id(6791752177267380)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10123957560892313)
,p_plug_template_id=>wwv_flow_imp.id(6791752177267380)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(10124467571892313)
,p_plug_template_id=>wwv_flow_imp.id(6791752177267380)
,p_name=>'Sub Regions'
