...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(8601716414756970)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8602275206756973)
,p_plug_template_id=>wwv_flow_api.id(8601716414756970)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8602783526756973)
,p_plug_template_id=>wwv_flow_api.id(8601716414756970)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8603297763756973)
,p_plug_template_id=>wwv_flow_api.id(8601716414756970)
,p_name=>'Create'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8603756142756974)
,p_plug_template_id=>wwv_flow_api.id(8601716414756970)
,p_name=>'Delete'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8604280560756974)
,p_plug_template_id=>wwv_flow_api.id(8601716414756970)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8604790050756974)
,p_plug_template_id=>wwv_flow_api.id(8601716414756970)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8605203878756975)
,p_plug_template_id=>wwv_flow_api.id(8601716414756970)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8605787251756975)
,p_plug_template_id=>wwv_flow_api.id(8601716414756970)
,p_name=>'Sub Regions'
