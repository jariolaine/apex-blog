...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8540514866756922)
,p_plug_template_id=>wwv_flow_api.id(6801762579267386)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8541020182756922)
,p_plug_template_id=>wwv_flow_api.id(6801762579267386)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8541556920756923)
,p_plug_template_id=>wwv_flow_api.id(6801762579267386)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8542092399756923)
,p_plug_template_id=>wwv_flow_api.id(6801762579267386)
,p_name=>'Sub Regions'
