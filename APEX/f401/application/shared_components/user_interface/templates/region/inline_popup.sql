...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8528175098756913)
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8528679673756913)
,p_plug_template_id=>wwv_flow_api.id(5988422738475876)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8529142600756914)
,p_plug_template_id=>wwv_flow_api.id(5988422738475876)
,p_name=>'Create'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8529673185756914)
,p_plug_template_id=>wwv_flow_api.id(5988422738475876)
,p_name=>'Delete'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8530192189756914)
,p_plug_template_id=>wwv_flow_api.id(5988422738475876)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8530677064756915)
,p_plug_template_id=>wwv_flow_api.id(5988422738475876)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8531180168756915)
,p_plug_template_id=>wwv_flow_api.id(5988422738475876)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8531595007756915)
,p_plug_template_id=>wwv_flow_api.id(5988422738475876)
,p_name=>'Sub Regions'
