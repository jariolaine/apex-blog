...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8497970400756892)
,p_plug_template_id=>wwv_flow_api.id(6796339335267382)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8498486548756892)
,p_plug_template_id=>wwv_flow_api.id(6796339335267382)
,p_name=>'Change'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8498954311756893)
,p_plug_template_id=>wwv_flow_api.id(6796339335267382)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8499481685756893)
,p_plug_template_id=>wwv_flow_api.id(6796339335267382)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8499942671756893)
,p_plug_template_id=>wwv_flow_api.id(6796339335267382)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8500448835756893)
,p_plug_template_id=>wwv_flow_api.id(6796339335267382)
,p_name=>'Sub Regions'
