...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8545477752756926)
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8545965347756926)
,p_plug_template_id=>wwv_flow_api.id(6802357267267386)
,p_name=>'Create'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8546406757756926)
,p_plug_template_id=>wwv_flow_api.id(6802357267267386)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8546918352756926)
,p_plug_template_id=>wwv_flow_api.id(6802357267267386)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8547483092756927)
,p_plug_template_id=>wwv_flow_api.id(6802357267267386)
,p_name=>'Sub Regions'
