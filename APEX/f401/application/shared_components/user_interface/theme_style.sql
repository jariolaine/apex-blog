...
||' both;\n  margin: 2rem 0 0;\n  border-top: 1px solid rgba(0, 0, 0, 0.075);\n}\n.z-post--footer {\n  width: 100%;\n  clear: both;\n  margin: 1.2rem 0 0;\n}\n.z-posts--pagination {\n  margin-bottom: 16px;\n}\n.z-posts--paginationBorder .z-posts--pagina'
...
||'1.6rem;\n  font-weight: 500;\n  line-height: 2.4rem;\n}\n.z-Content--Body {\n  padding: 1.6rem;\n}\n.z-Content--Stacked .z-Content--Title {\n  border-top: 1px solid rgba(0, 0, 0, 0.075);\n}\n.z-Content--Stacked .z-Content--Row:first-child .z-Content-'
||'-Title {\n  border-top: none;\n}\n/**************************************\n* Program code formatting\n**************************************/\npre.z-program-code {\n  font-family: SFMono-Regular, Menlo, Monaco, Consolas, \"Liberation Mono\", \"Bitstr'
||'eam Vera Sans Mono\", \"Courier New\", monospace;\n  color: #262626;\n  font-size: 1.1rem;\n  tab-size: 2;\n  overflow-x: auto;\n  display: block;\n  padding: 1em 1.5em;\n  margin: 8px 8px 18px 8px;\n  border: 1px solid rgba(0, 0, 0, 0.075);\n  borde'
||'r-left: 0.3em solid #6ce26c;\n  border-radius: 4px;\n  background-color: rgba(0, 0, 0, 0.015);\n  box-shadow: 0 2px 4px -2px rgba(0, 0, 0, 0.075);\n}\npre.z-program-code code {\n  font-family: inherit;\n  font-size: inherit;\n}\n/********************'
||'******************\n* About content\n**************************************/\n.z-author-container {\n  display: flex;\n}\n.z-author-left {\n  order: 1;\n  display: flex;\n  flex-direction: column;\n}\n.z-author-right {\n  order: 2;\n  padding: 0 0 0 '
||'1.6rem;\n}\n.z-author-badges {\n  display: flex;\n  flex-direction: column;\n}\n.z-author-badges > * {\n  margin: 1rem 0;\n}\n@media only screen and (max-width: 640px) {\n  .z-author-container {\n    flex-direction: column;\n    align-items: center;\'
||'n  }\n  .z-author-right {\n    padding: 1.6rem 0;\n  }\n  .z-author-badges {\n    padding: 1.6rem 0;\n    align-items: center;\n  }\n}\n/**************************************\n* Comments report\n**************************************/\n.z-comment .t'
