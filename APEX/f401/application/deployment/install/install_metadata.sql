...
'insert into blog_features (is_active,display_seq,build_option_name,build_option_group,build_option_parent,help_message) values (''1'',''240'',''BLOG_FEATURE_CATEGORY_POST_COUNT'',''BLOG_FEATURE_GROUP_RIGHT_COLUMN'',''BLOG_FEATURE_CATEGORY'',''BLOG_HELP_FEATURE_'
||'CATEGORY_POST_COUNT'');',
...
'insert into blog_features (is_active,display_seq,build_option_name,build_option_group,build_option_parent,help_message) values (''1'',''260'',''BLOG_FEATURE_ARCHIVE_POST_COUNT'',''BLOG_FEATURE_GROUP_RIGHT_COLUMN'',''BLOG_FEATURE_ARCHIVE'',''BLOG_HELP_FEATURE_AR'
||'CHIVE_POST_COUNT'');',
...
'insert into blog_features (is_active,display_seq,build_option_name,build_option_group,build_option_parent,help_message) values (''1'',''320'',''BLOG_FEATURE_MODERATE_COMMENTS'',''BLOG_FEATURE_GROUP_COMMENTS'',''BLOG_FEATURE_ALLOW_COMMENTS'',''BLOG_HELP_FEATURE_'
||'MODERATE_COMMENTS'');',
'insert into blog_features (is_active,display_seq,build_option_name,build_option_group,build_option_parent,help_message) values (''1'',''330'',''BLOG_FEATURE_SUBSCRIBE_COMMENTS'',''BLOG_FEATURE_GROUP_COMMENTS'',''BLOG_FEATURE_ALLOW_COMMENTS'',''BLOG_HELP_FEATURE'
||'_SUBSCRIBE_COMMENTS'');',
...
'insert into blog_settings (display_seq,is_nullable,attribute_name,data_type,attribute_group_message,post_expression,int_min,int_max,attribute_value) values (''210'',''0'',''G_APP_DATE_FORMAT'',''DATE_FORMAT'',''BLOG_SETTING_GROUP_UI'',null,null,null,''fmDD Mon '
||'YYYY'');',
'insert into blog_settings (display_seq,is_nullable,attribute_name,data_type,attribute_group_message,post_expression,int_min,int_max,attribute_value) values (''220'',''0'',''G_POST_TITLE_DATE_FORMAT'',''DATE_FORMAT'',''BLOG_SETTING_GROUP_UI'',null,null,null,''fm'
||'Day, Month DD, YYYY'');',
...
'insert into blog_settings (display_seq,is_nullable,attribute_name,data_type,attribute_group_message,post_expression,int_min,int_max,attribute_value) values (''410'',''1'',''G_CANONICAL_HOST'',''URL'',''BLOG_SETTING_GROUP_SEO'',''trim( rtrim( :ATTRIBUTE_VALUE, '''
||'''/'''' ) )'',null,null,null);',
