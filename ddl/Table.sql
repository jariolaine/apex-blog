...
CREATE TABLE  BLOG_CONTACT_MESSAGE 
   (    CONTACT_ID NUMBER(38,0) NOT NULL ENABLE, 
    ...
    MESSAGE VARCHAR2(4000 CHAR) NOT NULL ENABLE, 
     CONSTRAINT BLOG_CONTACT_MESSAGES_CK1 CHECK (CONTACT_ID > 0) ENABLE, 
     CONSTRAINT BLOG_CONTACT_MESSAGES_CK2 CHECK (USER_ID > 0) ENABLE, 
     CONSTRAINT BLOG_CONTACT_MESSAGES_CK3 CHECK (PROCESSED IN('Y', 'N')) ENABLE, 
     CONSTRAINT BLOG_CONTACT_MESSAGES_PK PRIMARY KEY (CONTACT_ID) ENABLE
   )
/
...
/
ALTER TABLE  BLOG_CONTACT_MESSAGE ADD CONSTRAINT BLOG_CONTACT_MESSAGES_FK1 FOREIGN KEY (USER_ID)
      REFERENCES  BLOG_COMMENT_USER (USER_ID) ENABLE
/
